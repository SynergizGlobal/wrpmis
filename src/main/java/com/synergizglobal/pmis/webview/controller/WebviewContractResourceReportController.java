...
public class WebviewContractResourceReportController {
	@InitBinder
    public void initBinder(WebDataBinder binder) {
        binder.registerCustomEditor(String.class, new StringTrimmerEditor(true));
    }
	public static Logger logger = Logger.getLogger(WebviewContractResourceReportController.class);
	...
	public ModelAndView contractResourceReport(@ModelAttribute ContractResource obj,HttpSession session,RedirectAttributes attributes){
		ModelAndView model = new ModelAndView(MobilePageConstants.resourceReport);
		try{
