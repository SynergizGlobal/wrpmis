                                ...
                                <table id="training_type_table" class="mdl-data-table">
                                    ...
                                    <tbody>
										<c:forEach var="obj" items="${trainingTypeDetails.dList1}" varStatus="indexs">
											<tr><td>
												<input type="hidden" id="training_typeId${indexs.count}" value="${obj.training_type }" class="findLengths"/>
    ...
    <script>
        ...
        function doValidate(value){
     	   ...
     	   while(count < validate){
     		   ...
     		   if(findVal == value){
     			   $('#training_typeError').text(print_value+' alreday exists').css('color', 'red');
     			   $('#bttn').prop('disabled', true);
     			   flag = false;
     			   return false;
     		   }else{
     			   $('#training_typeError').text('');
        ...
        $("#trainingTypeForm").submit(function (e) {
           	 if(validator.form()){ 
       			$(".page-loader").show();
        ...
        $("#updateTrainingTypeForm").submit(function (e) {
        	 if(validator1.form()){ 
     			$(".page-loader").show();
