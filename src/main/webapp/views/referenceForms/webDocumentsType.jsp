...
<head>
    ...
    <title>Web Documents Type</title>
                        ...
                        <div class="row no-mar">
                            <div class="col s12 center-align">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Web Documents Type</a>
                            </div>
                        </div>
                        <div class="row no-mar">
                                ...
                                <table id="type_table" class="mdl-data-table">
                                    ...
                                    <tbody>
										<c:forEach var="obj" items="${webDocumentsTypeDetails.dList1}" varStatus="indexs">
											<tr><td>
												<input type="hidden" id="typeId${indexs.count}" value="${obj.type }" class="findLengths"/>
												${obj.type }</td>
    ...
    <div id="addUpdateModal" class="modal">
		<form action="<%=request.getContextPath() %>/add-web-documents-type" id="weDocumentsTypeForm" name="weDocumentsTypeForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header">Add Web Documents Type <span class="right modal-action modal-close"><span
     ...
     <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-web-documents-type" id=updateWebDocumentsTypeForm name="updateWebDocumentsTypeForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header bg-m">Update Web Documents Type <span class="right modal-action modal-close" onclick="removeErrorMsg()"><span
                            class="material-icons">close</span></span></h5>
                <div class="row">
                    <div class="col m2 hide-on-small"></div>
                    <div class="col m8 s12">
    ...
    <script>
        ...
        function doValidate(value){
     	   ...
     	   while(count < validate){
     		   ...
     		   if(findVal == value){
     			   $('#typeError').text(print_value+' alreday exists').css('color', 'red');
        ...
        $("#weDocumentsTypeForm").submit(function (e) {
           	 if(validator.form()){ 
       			$(".page-loader").show();
        ...
        $("#updateWebDocumentsTypeForm").submit(function (e) {
        	 if(validator1.form()){ 
     			$(".page-loader").show();
     			$("#onlyUpdateModal").modal();
     			 if(updateFlag){
     				document.getElementById("updateWebDocumentsTypeForm").submit();	
     			 }
     			 $(".page-loader").hide();
     			 return false;
         }
      ...
      var validator1 = $('#updateWebDocumentsTypeForm').validate({
          	 rules: {
          		 	"value_new": {
      			 		  required: true
          			 }
