...
public class WorkDaoImpl implements WorkDao {
	...
	public Work getWork(String workId,Work works)throws Exception{
		...
		try {
			...
			while(resultSet.next()) {
				...
				work.setWorkChainageFilesList(getWorkChainagesFilesList(work.getProject_id_fk(),connection));
	...
	private List<Work> getWorkChainagesFilesList(String project_id, Connection connection) throws Exception {
		PreparedStatement stmt = null;
		ResultSet resultSet = null;
		List<Work> objsList = new ArrayList<Work>();
		Work obj = null;
		try {
			String qry ="SELECT uploaded_file,format(uploaded_on,'d-MM-yyyy') as uploaded_on from work_chainages_upload_data  where work_chainage_id='"+project_id+"'";
