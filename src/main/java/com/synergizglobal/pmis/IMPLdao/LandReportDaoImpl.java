...
public class LandReportDaoImpl implements LandReportDao{
	...
	public LandAcquisition getLandAcquisitionData(LandAcquisition obj) throws Exception {
		...
		try {
			...
			qry = qry + " GROUP BY work_id_fk,work_short_name,category_fk,la_sub_category_fk,la_sub_category) as a group by  work_id_fk,work_short_name,category_fk,la_sub_category order by work_id_fk,category_fk ";
			Object[] pValues = new Object[arrSize];
			int i = 0;
