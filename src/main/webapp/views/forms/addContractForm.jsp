	                            ...
	                            <div class="row">
	                                ...
	                                <div class="row">
		                                <div class="col s12 m6 l4 input-field" id="tender_opening_date_div">
		                                    <input id="tender_opening_date" name="tender_opening_date" type="text" class="validate datepicker">
		                                ...
		                                <div class="col s12 m6 l4 input-field" id="technical_eval_submission_div">
		                                    <input id="technical_eval_submission" name="technical_eval_submission" type="text" class="validate datepicker">
		                                ...
		                                <div class="col s12 m6 l4 input-field" id="financial_eval_submission_div">
		                                    <input id="financial_eval_submission" name="financial_eval_submission" type="text" class="validate datepicker">
	                             ...
	                             <div class="container container-no-margin" style="width: 100%;margin: 0 auto !important;max-width: 100% !important;padding-right:0px;">	 	                                
	                                <div class="row">
                                            ...
                                            <table id="app_com_tableRevision" class="mdl-data-table" style="width:100%;">
                                                ...
                                                <input type="hidden" id="sNoRevision" value="1">
                                                       <tr>
                                                        	...
                                                        	<textarea name="tender_bid_remarks0" maxlength="1000" data-length="1000" id="tender_bid_remarks" class="validate pmis-textarea w90 pdr4em" style="height: 59px;"></textarea>
		                            ...
		                            <div class="row" style="max-width:1280px;margin-left: 200px;">
 									...
 									<div class="table-div" style="max-width:1280px;margin-left: 200px;">
			                    		<div class="">
			                    		<div class=" col m12 s12 l12" style="margin-bottom:30px; padding:0;">
			                                <div class="row fixed-width">
	   ...
	   /*  let date_pickers = document.querySelectorAll('.datepicker');
        ...
        function addContractRevisionsRow()
        {
            ...
            var html = '<tr id="actionRevisionStRow' + rNo + '"><td><input id="revisionno' + rNo + '" name="revisionno" type="text" value="R'+ rowLr + '"></td>'
               ...
               +'<td><textarea id="tender_bid_remarks' + rNo + '" name="tender_bid_remarks" class="validate pmis-textarea w90 pdr4em" style="height: 59px;"></textarea></td>'
