												 ...
												 <div id="modal1${indexx.count }${index.count }" class="modal preview-modal">
												    <div class="modal-content">
												      ...
												      <div class="center-align" style="margin-top:50px">
												      	<embed src="#" width="100%" height="100vh" />
												      </div>
												    </div>
												 </div>
											</div>
									...
									<div class="folder-body">
										<div class="files-collection">	
											<div class="card card-file files-filter-data"	id="row1">
												...
												<div class="card-action flex">
													<a href="#modal1" class="modal-trigger"><i class="fa fa-eye"></i></a> 
									...
									<div class="folder-body">
										<div class="files-collection">	
											<div class="card card-file files-filter-data"	id="row1">
												...
												<div class="card-action flex">
													<a href="#modal2" class="modal-trigger"><i class="fa fa-eye"></i></a> 
													<a	href="#!" download><i class="fa fa-download"></i></a>
												</div>
												<div id="modal2"
													class="modal preview-modal">
													<div class="modal-content">
														...
														<div class="center-align" style="margin-top: 50px">
															<embed src="/pmis/resources/css/font-awesome-v.4.7.css" width="100%" height="100vh" />
														</div>
													</div>
												</div>
											</div>
									...
									<div class="folder-body">
										<div class="files-collection">	
											<div class="card card-file files-filter-data"	id="row1">
												...
												<div class="card-action flex">
													<a href="#modal3" class="modal-trigger"><i class="fa fa-eye"></i></a> 
													<a	href="#!" download><i class="fa fa-download"></i></a>
												</div>
												<div id="modal3"
													class="modal preview-modal">
