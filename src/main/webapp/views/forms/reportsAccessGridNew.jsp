    ...
    <script>
        ...
        function getReportsList(){
        	...
        	Object.keys(filtersMap).forEach(function (key) {
         	...
         	table = $('#data-table-forms').DataTable();
       		...
       		table.state.clear();	
       	 	var myParams = {module_name_fk : module_name_fk,soft_delete_status_fk : soft_delete_status_fk,user_type_access : user_type_access};
      ...
      //This function is used to get error message for all ajax calls
        ...
        function getAccessReport(form_id){
        	$("#form_id").val(form_id);
        	$('#getReport').attr('action', '<%=request.getContextPath()%>/get-access-report');
        	$('#getReport').submit();
        }
    </script>
</body>
