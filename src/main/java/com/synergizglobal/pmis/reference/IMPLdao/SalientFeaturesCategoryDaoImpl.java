...
public class SalientFeaturesCategoryDaoImpl implements SalientFeaturesCategoryDao{
	...
	private List<WorkFeatures> getTablesList(WorkFeatures obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='salient_features_category' and s.name='dbo'\r\n" + 
	...
	public boolean updateCategory(WorkFeatures obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table salient_features_category NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table salient_features_category CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
