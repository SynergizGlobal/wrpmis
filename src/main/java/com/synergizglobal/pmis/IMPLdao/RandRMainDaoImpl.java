...
public class RandRMainDaoImpl implements RandRMainDao{
	...
	private String getAgencyId(String agency_id) {
	...
	public String[] uploadRRData(List<RandRMain> rrsList, RandRMain rr) throws Exception {
		...
		//	int rNo = 0;
			for (RandRMain obj : rrsList) {
				...
				if(!StringUtils.isEmpty(obj.getWork_id()) && !StringUtils.isEmpty(obj.getIdentification_no()) && !StringUtils.isEmpty(obj.getLocation_name()) && !StringUtils.isEmpty(obj.getSub_location_name()) && !StringUtils.isEmpty(obj.getType_of_use()) && !StringUtils.isEmpty(obj.getBoundary_wall_status()))
				{
					row++;sheet = 1;
					if(!StringUtils.isEmpty(rr_id)) {
						obj.setRr_id(rr_id);
						String[] splitStr=obj.getIdentification_no().split(" - "); 
						obj.setIdentification_no(splitStr[1]);
						if(!StringUtils.isEmpty(obj) &&  !CommonConstants.ROLE_CODE_IT_ADMIN.equals(obj.getUser_role_code())) {
						...
						obj.setRr_id(rr_id);	
						obj.setIdentification_no(getAgencyId(obj.getIdentification_no()));
