...
<!-- Page Loader ends-->
    ...
    <script src="/pmis/resources/js/datetime-moment-v1.10.12.js"></script>
     ...
     function clearFilters() {
         ...
         window.location.href = "<%=request.getContextPath()%>/data-gathering";
 		...
 		$("#datatable-data-gathering")
 				.DataTable(
 						{
 							...
 							columnDefs : [ {
								...
								targets : [1,2], 
								className: 'hideCOl',
							},{ targets: [0,3], className: 'fw-111 no-sort'  },{ targets: [0,1,2,3], className: 'fw-15'  } ],
 							"sScrollX" : "100%",
 							"sScrollXInner" : "100%",
 							"ordering":false,
 		        ...
 		        "aoColumns": [
 		            ...
 		            { "mData": function(data,type,row){
 		         	...
 		         	{ "mData": function(data,type,row){
 		         		var id = "'"+data.id+"'";
 	                    var actions = '<a href="javascript:void(0);"  onclick="getDataGathering('+id+');" class="btn waves-effect waves-light bg-m t-c mob-btn" ><i class="fa fa-pencil"></i></a>';
 		            	return actions;
 		            } }
