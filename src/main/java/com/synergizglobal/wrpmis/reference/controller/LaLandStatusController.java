...
public class LaLandStatusController {
	...
	@RequestMapping(value="/la-land-status",method={RequestMethod.GET,RequestMethod.POST})
	public ModelAndView laLandStatus(HttpSession session,@ModelAttribute TrainingType obj){
		ModelAndView model = new ModelAndView(PageConstants.laLandStatus);
		try {
			...
			e.printStackTrace();
			logger.error("laLandStatus : " + e.getMessage());
		}
		return model;
	}
	
	
	@RequestMapping(value = "/add-la-land-status", method = {RequestMethod.POST})
	@ResponseBody
	public ModelAndView addLaStatus(@ModelAttribute Safety obj,RedirectAttributes attributes){
		ModelAndView model = new ModelAndView();
		try{
			model.setViewName("redirect:/la-land-status");
	...
	@RequestMapping(value = "/update-la-land-status", method = {RequestMethod.POST})
	@ResponseBody
	...
	@RequestMapping(value = "/delete-la-land-status", method = {RequestMethod.POST})
	@ResponseBody
