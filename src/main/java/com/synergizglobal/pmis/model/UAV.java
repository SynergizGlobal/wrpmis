...
public class UAV {
	...
	public MultipartFile getUAVFile() {
		return UAVFile;
	}

	public void setUAVFile(MultipartFile UAVFile) {
	...
	public String getFramecnt() {
		return framecnt;
	}

	public void setFramecnt(String framecnt) {
	...
	public MultipartFile getSrtFileUpload() {
		return srtFileUpload;
	}

	public void setSrtFileUpload(MultipartFile srtFileUpload) {
		this.srtFileUpload = srtFileUpload;
	}

	public MultipartFile getAnnotationFileUpload() {
		return annotationFileUpload;
	}
