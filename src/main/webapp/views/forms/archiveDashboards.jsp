...
<body style="background-color:#fff;">
  ...
  <script type="text/javascript" src="http://pmis.mrvc.gov.in:8000/javascripts/api/tableau-2.min.js"></script>
	...
	function getWorkId(rlc)
	{
	    ...
	    function changeUrl(dashboardId,work_id)
	    {
			 $.ajax({
		            ...
		            dataType: 'json',
		            success: function (data){
		            	var dashboard_url = data.dashboard_url+"&&embedded=true";
	 ...
	 function getSelectedOption(filterIds,dashboardId){
		 ...
		 $.ajax({
	            ...
	            success: function (data){
	            	...
	            	var dashboard_url = dashboard_url+"&&embedded=true";
	            	dashboard_url=dashboard_url.replace("trusted/-1/", "");
	         	    $("#dashboardOpen").attr("src",dashboard_url);
