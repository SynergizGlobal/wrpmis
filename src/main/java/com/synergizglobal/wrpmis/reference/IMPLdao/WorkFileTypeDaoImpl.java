...
import com.synergizglobal.wrpmis.reference.Idao.WorkFileTypeDao;
import com.synergizglobal.wrpmis.reference.model.TrainingType;

@Repository
public class WorkFileTypeDaoImpl implements WorkFileTypeDao{
	...
	public boolean addWorkFileType(TrainingType obj) throws Exception {
		...
		try {
			...
			String insertQry = "INSERT INTO work_file_type"
					+ "( work_file_type) VALUES (:work_file_type)";
