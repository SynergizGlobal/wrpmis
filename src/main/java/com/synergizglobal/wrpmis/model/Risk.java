...
public class Risk {
	...
	public String getPriority_risks() {
		return priority_risks;
	}

	public void setPriority_risks(String priority_risks) {
		this.priority_risks = priority_risks;
	}

	public String getLow_risks() {
		return low_risks;
	}

	public void setLow_risks(String low_risks) {
		this.low_risks = low_risks;
	}
}
