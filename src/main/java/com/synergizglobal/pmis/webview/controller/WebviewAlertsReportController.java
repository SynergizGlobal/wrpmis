...
public class WebviewAlertsReportController {
	@InitBinder
    public void initBinder(WebDataBinder binder) {
        binder.registerCustomEditor(String.class, new StringTrimmerEditor(true));
    }
	
	public static Logger logger = Logger.getLogger(WebviewAlertsReportController.class);	
	...
	public ModelAndView alertsReport(){
		...
		try{            
		    model = new ModelAndView(MobilePageConstants.alertReport);
	...
	public ModelAndView generateConractsAlertReport(@ModelAttribute Alerts obj ,HttpServletRequest request,HttpServletResponse response,HttpSession session, RedirectAttributes attributes){
		ModelAndView model = new ModelAndView("redirect:/mobileappwebview/get-alerts");
		try{            
