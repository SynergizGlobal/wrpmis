...
public class AlertLevelDaoImpl implements AlertLevelDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='alert_level' and s.name='dbo'\r\n" + 
	...
	public boolean updateAlertLevel(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table alert_level NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table alert_level CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
