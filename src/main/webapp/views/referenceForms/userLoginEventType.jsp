                        ...
                        <div class="row">
                            <div class="col s12 m6">
                               <div class="center-align m-1">
										<button type="button" onclick="addUserLoginEventType();" style="width: 100%;" class="btn waves-effect waves-light bg-m">Add</button>
								</div>
                            </div>
                            <div class="col s12 m6">
                                <div class="center-align m-1">
                    ...
                    <div class="col m8 s12">
                       <div class="row no-mar">
                        ...
                        <div class="row">
                            <div class="col s12 m6">
                                <div class="center-align m-1">
                                    <button style="width: 100%;" onclick="updateUserLoginEventType()"
...
<%--   <jsp:include page="../layout/footer.jsp"></jsp:include> --%>
    ...
    <script>
        ...
        function addUserLoginEventType(){
           	 if(validator.form()){ 
       			$(".page-loader").show();
