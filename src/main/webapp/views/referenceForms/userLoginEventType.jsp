...
<head>
    ...
    <title>User Login Event Type</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col m4 s12 center-align">
                                <a class="waves-effect waves-light btn bg-m modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add User Login Event Type</a>
                            </div>
                            <div class="col m4 hide-on-small"></div>
                        </div>
                                ...
                                <table id="login_event_type_table" class="mdl-data-table">
                                    <thead>
                                        <tr>
                                            <th>User Login Event Type</th>
                                             <c:forEach var="tObj" items="${userLoginEventTypeDetails.tablesList}" >
                                    ...
                                    <tbody>
										<c:forEach var="obj" items="${userLoginEventTypeDetails.dList1}" varStatus="indexs">
											<tr><td>
												<input type="hidden" id="login_event_typeId${indexs.count}" value="${obj.login_event_type }" class="findLengths"/>
    ...
    <div id="addUpdateModal" class="modal">
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="login_event_type_text" name="login_event_type" type="text" class="validate" onkeyup="doValidate(this.value)">
     ...
     <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-user-login-event-type" id=updateUserLoginEventTypeForm name="updateUserLoginEventTypeForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header bg-m">Update User Login Event Type <span class="right modal-action modal-close" onclick="removeErrorMsg()"><span
                            class="material-icons">close</span></span></h5>
                <div class="row">
                    <div class="col m2 hide-on-small"></div>
                    <div class="col m8 s12">
                       <div class="row no-mar">
                         <div class="input-field col s12 m12">
                                ...
                                <label for="value_new">User Login Event Type</label>
    ...
    <script>
        ...
        function doValidate(value){
     	   ...
     	   while(count < validate){
     		   ...
     		   if(findVal == value){
     			   $('#login_event_typeError').text(print_value+' alreday exists').css('color', 'red');
     			   $('#bttn').prop('disabled', true);
     			   flag = false;
     			   return false;
     		   }else{
     			   $('#login_event_typeError').text('');
    	...
    	function removeErrorMsg(){
          ...
          $("#userLoginEventTypeForm").submit(function (e) {
           	 if(validator.form()){ 
       			$(".page-loader").show();
          ...
          $("#updateUserLoginEventTypeForm").submit(function (e) {
        	 if(validator1.form()){ 
     			$(".page-loader").show();
      ...
      var validator1 = $('#updateUserLoginEventTypeForm').validate({
          	 rules: {
          		 	"value_new": {
      			 		  required: true
          			 }
