...
<%-- <jsp:include page="../layout/header.jsp"></jsp:include> --%>
                                ...
                                <table id="p6_wbs_category_table" class="mdl-data-table">
                                    ...
                                    <tbody>
										<c:forEach var="obj" items="${p6WbsCategoryDetails.dList1}" varStatus="indexs">
											<tr><td>
												<input type="hidden" id="p6_wbs_categoryId${indexs.count}" value="${obj.p6_wbs_category }"  class="findLengths"/>
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="p6_wbs_category_text" name="p6_wbs_category" type="text" class="validate" onkeyup="doValidate(this.value)">
    ...
    <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-p6wbs-category" id=updateP6wbsCategoryForm name="updateP6wbsCategoryForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header bg-m">Update p6wbs-category <span class="right modal-action modal-close" onclick="removeErrorMsg()"><span
                            class="material-icons">close</span></span></h5>
                <div class="row">
                    <div class="col m2 hide-on-small"></div>
                    <div class="col m8 s12">
    ...
    <script>
        ...
        function doValidate(value){
     	   ...
     	   while(count < validate){
     		   ...
     		   if(findVal == value){
     			   $('#p6_wbs_categoryError').text(print_value+' alreday exists').css('color', 'red');
     			   $('#bttn').prop('disabled', true);
     			   flag = false;
     			   return false;
     		   }else{
     			   $('#p6_wbs_categoryError').text('');
      ...
      $("#addP6wbsCategoryForm").submit(function (e) {
          	 if(validator.form()){ 
      			$(".page-loader").show();
      ...
      $("#updateP6wbsCategoryForm").submit(function (e) {
        	 if(validator1.form()){ 
    			$(".page-loader").show();
    			$("#addUpdateModal").modal();
    			 if(updateFlag){
