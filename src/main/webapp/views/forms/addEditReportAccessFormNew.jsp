        ...
        <div class="col s12 m12">
            <div class="card ">
                <div class="card-content">
                    ...
                    <!-- form start-->
                    <form action="<%=request.getContextPath() %>/update-access-report" id="accessReport" name="accessReport" method="post" class="form-horizontal" role="form" >
                        ...
                        <div class="container container-no-margin">                            
                            ...
                            <div class="row">
                                ...
                                <div class="col s6 m4 l6 mt-brdr center-align">
                                    <div class=" m-1">
                                        <a href="<%=request.getContextPath()%>/access-reports" class="btn waves-effect waves-light bg-s">Cancel</a>
                                    </div>
                                </div>
