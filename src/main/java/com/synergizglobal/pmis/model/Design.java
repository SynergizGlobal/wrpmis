...
public class Design {
	...
	public String getDesign_seq_id() {
		return design_seq_id;
	}

	public void setDesign_seq_id(String design_seq_id) {
		this.design_seq_id = design_seq_id;
	}
	...
	public String getDrawing_type_code() {
		return drawing_type_code;
	}
