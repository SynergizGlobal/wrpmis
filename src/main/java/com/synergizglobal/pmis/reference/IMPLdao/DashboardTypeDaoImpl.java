...
public class DashboardTypeDaoImpl implements DashboardTypeDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='dashboard_type' and s.name='dbo'\r\n" + 
	...
	public boolean updateDashBoardType(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table dashboard_type NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table dashboard_type CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
