...
<%-- <jsp:include page="../layout/header.jsp"></jsp:include> --%>
                        ...
                        <div class="row">
                            ...
                            <div class="col m4 s12 center-align">
                                <a class="waves-effect waves-light btn bg-m modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Fob File Type</a>
                            </div>
                            <div class="col m4 hide-on-small"></div>
                        </div>
    ...
    <div id="addUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/add-fob-file-type" id="addFobFileTypeForm" name="addFobFileTypeForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header ">Add Fob File Type <span class="right modal-action modal-close"><span
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="fob_file_type" name="fob_file_type" type="text" class="validate" onkeyup="doValidate(this.value)">
                                <label for="fob_file_type">Fob File Type</label>
                                 <span id="fob_file_typeError" class="error-msg" ></span>
                            </div>
                        </div>
                        <div class="row">
 ...
 <div id="onlyUpdateModal" class="modal">
                    ...
                    <div class="col m8 s12">
                       <div class="row no-mar">
                         <div class="input-field col s12 m12">
                                ...
                                <label for="value_new">Fob File Type</label>
    ...
    <!-- footer  -->
 	<form name="getForm" id="getForm" method="post">
    	<input type="hidden" name="fob_file_type" id="idNo" />
    </form>
    ...
    <script>
        $(document).ready(function () {
           ...
           /*  // adding table data into table start
            ...
            var table = $('#fob_file_type_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
        ...
        function doValidate(value){
     	   ...
     	   while(count < validate){
     		   ...
     		   if(findVal == value){
     			   $('#fob_file_typeError').text(print_value+' alreday exists').css('color', 'red');
     			   $('#bttn').prop('disabled', true);
     			   flag = false;
     			   return false;
     		   }else{
     			   $('#fob_file_typeError').text('');
    	...
    	function removeErrorMsg(){
         ...
         $("#addFobFileTypeForm").submit(function (e) {
         	 if(validator.form()){ 
     			$(".page-loader").show();
     			$("#addUpdateModal").modal();
     			document.getElementById("addFobFileTypeForm").submit();
     			 if(flag){
     				document.getElementById("addFobFileTypeForm").submit();	
     			 }
     			 $(".page-loader").hide();
         ...
         $("#updateFobFileTypeForm").submit(function (e) {
         	 if(validator1.form()){ 
     			$(".page-loader").show();
     			$("#onlyUpdateModal").modal();
     			document.getElementById("updateFobFileTypeForm").submit();	
     			 if(updateFlag){
     				document.getElementById("updateFobFileTypeForm").submit();	
     			 }
     			 $(".page-loader").hide();
        ...
        var validator =  $('#addFobFileTypeForm').validate({
        	 rules: {
        		 "fob_file_type": {
 			 		  required: true
        		 }
 	        	 ...
 	        	 if(element.attr("id") == "fob_file_type" ){
 				     document.getElementById("fob_file_typeError").innerHTML="";
 			 	     error.appendTo('#fob_file_typeError');
 				 }
 	        }
        	
        });
        
        var validator1 =  $('#updateFobFileTypeForm').validate({
          	 rules: {
          		 "value_new": {
    			 		  required: true
          		 }
           ...
           function updateRow(no) {
       	      ...
       	      $('#onlyUpdateModal #value_new').val($.trim(fob_file_type)).focus();
       	  }
