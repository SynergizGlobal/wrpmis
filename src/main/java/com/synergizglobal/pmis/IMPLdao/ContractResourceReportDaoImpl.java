...
public class ContractResourceReportDaoImpl implements ContractResourceReportDao{
	...
	public List<ContractResource> getHODsListForContractResourceForm(ContractResource obj) throws Exception {
		...
		try {
			...
			qry = qry + "  group by user_id ORDER BY FIELD(designation,'ED Civil','CPM I','CPM II','CPM III','CPM V','CE','GGM Civil','ED S&T','CSTE','GM Electrical','CEE Project I','CEE Project II','ED Finance & Planning','FA&CAO','GM GA&S','CPO','COM','GM Procurement','OSD','CVO'),designation" ;
