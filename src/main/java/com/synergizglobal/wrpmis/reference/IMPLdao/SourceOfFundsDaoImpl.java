...
import com.synergizglobal.wrpmis.reference.Idao.SourceOfFundsDao;
...
public class SourceOfFundsDaoImpl implements SourceOfFundsDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='source_of_funds' and s.name='dbo'\r\n" + 
	...
	public boolean updateSourceOfFunds(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table source_of_funds NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table source_of_funds CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
