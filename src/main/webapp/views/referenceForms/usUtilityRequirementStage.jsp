                             ...
                             <div class="col s12 m6">
                                <div class="center-align m-1">
                                  <!--   <button
                                        ...
                                        <a href="<%=request.getContextPath()%>/us-utility-requirement-stage"
                    ...
                    <div class="col m8 s12 offset-m2">
                       <div class="row no-mar">
                         <div class="input-field col s12 m12">
                                ...
                                <label for="value_new"> Utility Requirement Stage</label>
    ...
    <script>
        ...
        function addUsCategory(){
          	 if(validator.form()){ 
      			...
      			document.getElementById("addUsUtilityRequirementStageForm").submit();	
             }
         }
        function updateUsCategory(){
          	 if(validator1.form()){ 
       			$(".page-loader").show();
       			$("#addUpdateModal").modal();
       			document.getElementById("updateUsUtilityRequirementStageForm").submit();	
           }
       }
         ...
         var validator1 = $('#updateUsUtilityRequirementStageForm').validate({
        	 rules: {
        		 	"value_new": {
    			 		  required: true
        			 }
