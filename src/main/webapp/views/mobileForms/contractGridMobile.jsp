...
<head>
	...
	<style>
		...
		/*additional styling for mobile grid */
                            ...
                            <div class="col m8 s12 ">
                                <div class="row" style="margin-bottom: 0;">
                                    ...
                                    <p><label>Contractor</label></p>
                                        <select id="contractor_id_fk" name="contractor_id_fk" onchange="getContractList(); getWorkList(); getDeptList();getIdVal(contractor_id_fk);" class="searchable">
                                            <option value="">Select</option>
...
<div class="page-loader" style="display: none;">
		...
		$.ajax({url : "<%=request.getContextPath()%>/ajax/getContracts",type:"POST",data:myParams,success : function(data){    				
				if(data != null && data != '' && data.length > 0){    					
	         		$.each(data,function(key,val){
	                    ...
	                    var actions = '<a href="javascript:void(0);"  onclick="getContract('+contract_id+');" class="btn mobile_btn waves-effect waves-light bg-m t-c" title="Edit"><i class="fa fa-pencil"></i></a>';    	                   	
	                   	var rowArray = [];    	                 
 ...
 /*    function getContractorVal(){
    	var contractor_val=$('#contractor_id_fk');
    	console.log(contractor_val);
   } */
    </script>
 <script>
	function getIdVal(a){
		//var contract_value=document.querySelectorAll('#contractor_id_fk>option:hidden');
		var contract_value=document.getElementById(a);
