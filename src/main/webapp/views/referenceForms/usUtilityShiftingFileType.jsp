...
<head>
    ...
    <title>Utility Shifting File Type</title>
...
<body>
                ...
                <div class="card-content">
                    <span class="card-title headbg">
                        <div class="center-align bg-m p-2 m-b-5">
                            <h6>Utility Shifting File Type</h6>
                        </div>
                    </span>
                        ...
                        <div class="row no-mar">
                            <div class="col s12 center-align">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Utility Shifting File Type</a>
                            </div>
                        </div>
                        <div class="row no-mar">
    ...
    <div id="addUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/add-us-utility-shifting-file-type" id="addUsUtilityShiftingFileTypeForm" name="addUsUtilityShiftingFileTypeForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h6 class="modal-header">Add Utility Shifting File Type <span class="right modal-action modal-close"><span
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="us_utility_shifting_file_type_text" type="text" name="us_utility_shifting_file_type" class="validate" onkeyup="doValidate(this.value)">
                             ...
                             <div class="col s12 m6">
                                <div class="center-align m-1">
                                  <!--   <button
                                        ...
                                        <a href="<%=request.getContextPath()%>/us-utility-shifting-file-type"
     ...
     <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-us-utility-shifting-file-type" id=updateUsUtilityShiftingFileTypeForm name="updateUsUtilityShiftingFileTypeForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h6 class="modal-header bg-m">Update Utility Shifting File Type <span class="right modal-action modal-close"><span
                            class="material-icons">close</span></span></h6>
                <div class="row">
                    <div class="col m8 s12 offset-m2">
                       <div class="row no-mar">
                         <div class="input-field col s12 m12">
                                ...
                                <label for="value_new"> Utility Shifting File Type</label>
    ...
    <script>
        ...
        function addUsCategory(){
          	 if(validator.form()){ 
      			...
      			document.getElementById("addUsUtilityShiftingFileTypeForm").submit();	
             }
         }
        function updateUsCategory(){
          	 if(validator1.form()){ 
       			$(".page-loader").show();
       			$("#addUpdateModal").modal();
       			document.getElementById("updateUsUtilityShiftingFileTypeForm").submit();	
           }
       }
         ...
         var validator1 = $('#updateUsUtilityShiftingFileTypeForm').validate({
        	 rules: {
        		 	"value_new": {
    			 		  required: true
        			 }
        	...
        	swal({
    	            ...
    	            if (isConfirm) {
    	               // swal("Deleted!", "Record has been deleted", "success");
    	                $(".page-loader").show();
    	            	$('#getForm').attr('action', '<%=request.getContextPath()%>/delete-us-utility-shifting-file-type');
    	    	    	$('#getForm').submit();
    	           }else {
