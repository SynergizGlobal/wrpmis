...
<head>
    ...
    <title>Document Revision Status</title>
...
<body>
                ...
                <div class="card-content">
                    <span class="card-title headbg">
                        <div class="center-align bg-m p-2 m-b-5">
                            <h6>Document Revision Status </h6>
                        </div>
                    </span>
                        ...
                        <div class="row no-mar">
                            <div class="col s12 center-align">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Document Revision Status</a>
                            </div>
                        </div>
                        <div class="row no-mar">
                            <div class="col m12 s12">
                                <table id="document_revision_status_table" class="mdl-data-table">
                                    <thead>
                                        <tr>
                                            <th>Document Revision Status</th>
                                             <c:forEach var="tObj" items="${documentRevisionStatusDetails.tablesList}" >
                                    ...
                                    <tbody>
										<c:forEach var="obj" items="${documentRevisionStatusDetails.dList1}" varStatus="indexs">
											<tr><td>
											<input type="hidden" id="statusId${indexs.count}" value="${obj.status }"  class="findLengths"/>
											${obj.status }</td>
										  <c:forEach var="tObj" items="${documentRevisionStatusDetails.tablesList}" varStatus="index">
											 
												<td><c:forEach var="cObj" items="${documentRevisionStatusDetails.countList}" >
												<c:choose> 
											...
											<td class="last-column "><a onclick="updateRow(${indexs.count})" class="btn waves-effect waves-light bg-m t-c"> <i class="fa fa-pencil" ></i></a>
										 	<c:forEach var="oSbj"  items="${documentRevisionStatusDetails.dList}" varStatus="indexx"> 
    ...
    <div id="addUpdateModal" class="modal">
		<form action="<%=request.getContextPath() %>/add-document-revision-status" id="addStatusForm" name="addStatusForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header">Add Document Revision Status <span class="right modal-action modal-close"><span
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="document_revision_status_text" type="text" name="status" class="validate" onkeyup="doValidate(this.value)">
                                <label for="document_revision_status_text">Document Revision Status</label>
                            ...
                            <div class="col s6 m6">
                                <div class="center-align m-1">
                                  <!--   <button
                                        ...
                                        <a href="<%=request.getContextPath()%>/document-revision-status"
     ...
     <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-document-revision-status" id=updateStatusForm name="updateStatusForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header bg-m">Update Document Revision Status <span class="right modal-action modal-close"  onclick="removeErrorMsg()"><span
                            class="material-icons">close</span></span></h5>
                <div class="row">
                    <div class="col m2 hide-on-small"></div>
                    <div class="col m8 s12">
                       <div class="row no-mar">
                         <div class="input-field col s12 m12">
                                ...
                                <label for="status_new">Document Revision Status</label>
...
<script src="/pmis/resources/js/dataTables.fixedColumns.min.js"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#document_revision_status_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
    	  ...
    	  var validator = $('#addStatusForm').validate({
    	  	 rules: {
    	  		 	"status": {
    		        	 ...
    		        	 if(element.attr("id") == "document_revision_status_text" ){
