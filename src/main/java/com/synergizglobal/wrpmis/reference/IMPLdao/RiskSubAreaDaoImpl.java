...
import com.synergizglobal.wrpmis.reference.Idao.RiskSubAreaDao;
...
public class RiskSubAreaDaoImpl implements RiskSubAreaDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='risk_sub_area' and s.name='dbo'\r\n" + 
	...
	public boolean updateRiskSubArea(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table risk_sub_area NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table risk_sub_area CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
