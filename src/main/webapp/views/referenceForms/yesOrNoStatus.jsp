...
<body>
                        ...
                        <div class="row no-mar">
                            <div class="col s12 center-align">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Yes or No</a>
                            </div>
                        </div>
                        <div class="row no-mar">
                            <div class="col m12 s12">
                                <table id="yes_or_no_status_table" class="mdl-data-table">
                                    <thead>
                                        <tr>
                                            <th>Yes or No</th>
                                             <c:forEach var="tObj" items="${yesOrNoStatusDetails.tablesList}" >
                                    ...
                                    <tbody>
										<c:forEach var="obj" items="${yesOrNoStatusDetails.dList1}" varStatus="indexs">
											<tr><td>
												<input type="hidden" id="yesOrNoStatusId${indexs.count}" value="${obj.yesorno }" class="findLengths"/>
												${obj.yesorno }</td>
    ...
    <div id="addUpdateModal" class="modal">
		<form action="<%=request.getContextPath() %>/add-yes-or-no-status" id="yesOrNoStatusForm" name="yesOrNoStatusForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header">Add Yes or No <span class="right modal-action modal-close"><span
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="yes_or_no_status_text" name="yesorno" type="text" class="validate" onkeyup="doValidate(this.value)">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m6">
                                <div class="center-align m-1">
                                    <a href="<%=request.getContextPath()%>/yes-or-no-status"
     ...
     <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-yes-or-no-status" id=updateYesOrNoStatusForm name="updateYesOrNoStatusForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header bg-m">Update Yes or No <span class="right modal-action modal-close" onclick="removeErrorMsg()"><span
                            class="material-icons">close</span></span></h5>
                <div class="row">
                    <div class="col m2 hide-on-small"></div>
                    <div class="col m8 s12">
                       <div class="row no-mar">
                         <div class="input-field col s12 m12">
                                ...
                                <label for="value_new">Yes or No</label>
...
<%--   <jsp:include page="../layout/footer.jsp"></jsp:include> --%>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#yes_or_no_status_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
        ...
        function doValidate(value){
     	   ...
     	   while(count < validate){
     		   ...
     		   if(findVal == value){
     			   $('#yes_or_no_statusError').text(print_value+' alreday exists').css('color', 'red');
     			   $('#bttn').prop('disabled', true);
     			   flag = false;
     			   return false;
     		   }else{
     			   $('#yes_or_no_statusError').text('');
    	...
    	function removeErrorMsg(){
         ...
         $("#yesOrNoStatusForm").submit(function (e) {
           	 if(validator.form()){ 
       			$(".page-loader").show();
       			$("#addUpdateModal").modal();
       			document.getElementById("yesOrNoStatusForm").submit();	
	       		 if(flag){
	 				document.getElementById("yesOrNoStatusForm").submit();	
	 			 }
	 			 $(".page-loader").hide();
         ...
         $("#updateYesOrNoStatusForm").submit(function (e) {
        	 if(validator1.form()){ 
     			$(".page-loader").show();
     			$("#onlyUpdateModal").modal();
     			document.getElementById("updateYesOrNoStatusForm").submit();	
     			 if(updateFlag){
     				document.getElementById("updateYesOrNoStatusForm").submit();	
     			 }
     			 $(".page-loader").hide();
        ...
        var validator =	$('#yesOrNoStatusForm').validate({
       	 rules: {
        	 ...
        	 if(element.attr("id") == "yes_or_no_status_text" ){
			     document.getElementById("yes_or_no_statusError").innerHTML="";
		 	     error.appendTo('#yes_or_no_statusError');
			 }
        }
      });
      var validator1 = $('#updateYesOrNoStatusForm').validate({
          	 rules: {
          		 	"value_new": {
      			 		  required: true
          			 }
          	...
          	swal({
      	            ...
      	            if (isConfirm) {
      	               // swal("Deleted!", "Record has been deleted", "success");
      	                $(".page-loader").show();
      	            	$('#getForm').attr('action', '<%=request.getContextPath()%>/delete-yes-or-no-status');
      	    	    	$('#getForm').submit();
      	           }else {
