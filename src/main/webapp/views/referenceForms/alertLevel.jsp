    ...
    <div id="addUpdateModal" class="modal">
		<form action="<%=request.getContextPath() %>/add-alert-level" id="alertLevelForm" name="alertLevelForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header">Add Alert Level <span class="right modal-action modal-close"><span
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="alert_level_text" name="alert_level" type="text" class="validate">
