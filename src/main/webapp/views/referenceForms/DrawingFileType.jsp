                        ...
                        <div class="row no-mar">
                            <div class="col m4 s12 center-align offset-m4">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Drawing File Type</a>
                            </div>
                        </div>
                        <div class="row no-mar">
...
<script src="/pmis/resources/js/dataTables.fixedColumns.min.js"></script>
	...
	<script src="/pmis/resources/js/sweetalert-v.1.1.0.min.js"></script>
      <script>
        ...
        $("#addDrawingFileTypeForm").submit(function (e) {
         	 if(validator.form()){ 
     			$(".page-loader").show();
     			$("#addUpdateModal").modal();
     			if(flag){
    				document.getElementById("addDrawingFileTypeForm").submit();	
    			 }
    			 $(".page-loader").hide();
    			 return false;
          }
       })
        $("#updateDrawingFileTypeForm").submit(function (e) {
       	 if(validator1.form()){ 
   			$(".page-loader").show();
   			$("#addUpdateModal").modal();
   			if(updateFlag){
 				document.getElementById("updateDrawingFileTypeForm").submit();	
 			 }
 			 $(".page-loader").hide();
 			 return false;
        }
