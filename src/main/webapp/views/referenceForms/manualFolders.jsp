                                ...
                                <table id="manual_folders_table" class="mdl-data-table">
                                    ...
                                    <tbody>
										<c:forEach var="obj" items="${manualFoldersDetails.dList1}" varStatus="indexs">
											<tr><td>
												<input type="hidden" id="manual_foldersId${indexs.count}" value="${obj.manual_folders }" />
    ...
    <div id="addUpdateModal" class="modal">
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="manual_folders_text" type="text" name="manual_folders" class="validate">
                        ...
                        <div class="row">
                            <div class="col s12 m6">
                                <div class="center-align m-1">
                                    <button style="width: 100%;" onclick="addManualFolders()"
     ...
     <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-manual-folders" id=updateManualFoldersForm name="updateManualFoldersForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header bg-m">Update Manual Folders <span class="right modal-action modal-close"><span
                            class="material-icons">close</span></span></h5>
                <div class="row">
                    <div class="col m2 hide-on-small"></div>
                    <div class="col m8 s12">
                       <div class="row no-mar">
                        ...
                        <div class="row">
                            <div class="col s12 m6">
                                <div class="center-align m-1">
                                    <button style="width: 100%;" onclick="updateManualFolders()"
