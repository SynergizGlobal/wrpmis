...
<%-- <jsp:include page="../layout/header.jsp"></jsp:include> --%>
                        ...
                        <div class="row">
                            ...
                            <div class="col m4 s12 center-align">
                                <a class="waves-effect waves-light btn bg-m modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Utility Type</a>
                            </div>
                            <div class="col m4 hide-on-small"></div>
                        </div>
                        <div class="row no-mar">
                            <div class="col m12 s12">
                                <table id="utility_type_table" class="mdl-data-table">
                                    <thead>
                                        <tr>
                                            <th>Utility Type</th>
    ...
    <div id="addUpdateModal" class="modal">
		<form action="<%=request.getContextPath() %>/add-utility-type" id="utilityTypeForm" name="utilityTypeForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header">Add Utility Type <span class="right modal-action modal-close"><span
                   ...
                   <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="utility_type_text" name="utility_type" type="text" class="validate">
                                <label for="utility_type_text">Utility Status</label>
                                <span id="utility_typeError" class="error-msg" ></span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col s12 m6">
                                <div class="center-align m-1">
                                    <button style="width: 100%;" onclick="addUtilityType();"
    ...
    <script>
        $(document).ready(function () {
          ...
          /*   // adding table data into table start
            ...
            $('#utility_type_table tbody').append(table_text);
            // adding table data into table ends */

            var table = $('#utility_type_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
      ...
      function addUtilityType(){
      	 if(validator.form()){ 
  			...
  			document.getElementById("utilityTypeForm").submit();	
      	}
   }
   
   var validator =	$('#utilityTypeForm').validate({
  	 rules: {
  		 "utility_type": {
			 		  required: true
			 	  }
   	 ...
   	 if(element.attr("id") == "utility_type_text" ){
			     document.getElementById("utility_typeError").innerHTML="";
		 	     error.appendTo('#utility_typeError');
			 }
     }
	  });
