...
public class LandAcquisitionServiceImpl implements LandAcquisitionService{
	...
	@Override
	public List<LandAcquisition> getTalukaVillageCollectorList(LandAcquisition dObj) throws Exception {
		return dao.getTalukaVillageCollectorList(dObj);
	}
	
	@Override
	public List<LandAcquisition> getLandProcessProjectsList(LandAcquisition dObj) throws Exception {
		return dao.getLandProcessProjectsList(dObj);
	}

	@Override
	public int getTotalLARecords(LandAcquisition obj, String searchParameter) throws Exception {
		return dao.getTotalLARecords(obj,searchParameter);
	}

	@Override
	public List<LandAcquisition> getLandAcquisitionProcessList(LandAcquisition obj, int startIndex, int offset,
			String searchParameter) throws Exception {
		return dao.getLandAcquisitionProcessList(obj,startIndex,offset,searchParameter);
	}

	@Override
	public LandAcquisitionProcess getLandAcquisitionProcessForm(LandAcquisitionProcess obj) {
		return dao.getLandAcquisitionProcessForm(obj);
	}
	
	@Override
	public List<LandAcquisitionProcess> getLandProcessProjectsList(LandAcquisitionProcess obj) throws Exception 
	{
		return dao.getLandProcessProjectsList(obj);
	}
}
