...
import com.synergizglobal.wrpmis.reference.Idao.SafetyRootCauseDao;
...
public class SafetyRootCauseDaoImpl implements SafetyRootCauseDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='safety_root_cause' and s.name='dbo'\r\n" + 
	...
	public boolean updateSafetyRootCause(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table safety_root_cause NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table safety_root_cause CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
