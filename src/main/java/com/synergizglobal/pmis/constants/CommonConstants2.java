...
public class CommonConstants2 {	
	...
	public final static String ISSUE_FILE_SAVING_PATH = "C:"+File.separator+"Development"+File.separator+"nginx-1.9.9"+File.separator+"html"+File.separator+"pmis"+File.separator+"ISSUE_FILES"+File.separator;
	public static final String SAFETY_FILE_SAVING_PATH = "C:"+File.separator+"Development"+File.separator+"nginx-1.9.9"+File.separator+"html"+File.separator+"pmis"+File.separator+"SAFETY_FILES"+File.separator;
	public static final String FOB_FILE_SAVING_PATH = "C:"+File.separator+"Development"+File.separator+"nginx-1.9.9"+File.separator+"html"+File.separator+"pmis"+File.separator+"FOB_FILES"+File.separator;
	public static final String USER_IMAGE_SAVING_PATH = "C:"+File.separator+"Development"+File.separator+"nginx-1.9.9"+File.separator+"html"+File.separator+"pmis"+File.separator+"USER_IMAGES"+File.separator;
	public static final String DESIGN_FILE_SAVING_PATH = "C:"+File.separator+"Development"+File.separator+"nginx-1.9.9"+File.separator+"html"+File.separator+"pmis"+File.separator+"DESIGN_FILES"+File.separator;
	...
	public final static String WEB_DOCUMENTS_FILE_SAVING_PATH = "C:/Development/nginx-1.9.9/html/pmis/WEB_DOCUMENTS/";
	public final static String PROJECT_GALLERY_FILE_SAVING_PATH = "C:/Development/nginx-1.9.9/html/pmis/PROJECT_GALLERY/";
	//public final static String ACTIVITY_PROGRESS_FILE_SAVING_PATH = "C:/Development/nginx-1.9.9/html/pmis/ACTIVITY_PROGRESS_REPORTS/";
	...
	public final static String RISK_ASSESSMENT_UPLOADED_FILE_SAVING_PATH = "C:/Development/nginx-1.9.9/html/pmis/RISK_ASSESSMENT_UPLOADED_FILES/";
