...
public class RRSVerificationByDaoImpl implements RRSVerificationByDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='rr_verification_by' and s.name='dbo'\r\n" + 
	...
	public boolean updateRRSVerificationBy(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table rr_verification_by NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table rr_verification_by CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
