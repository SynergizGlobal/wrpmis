                            	...
                            	<form id="reportForm" name="reportForm" method="post">
	                                <div class="row no-mar">
	                                	<div class="col s6 m4 l3 input-field">
	                                        ...
	                                        <select class="searchable validate-dropdown" id="hod_user_id_fk" name="hod_user_id_fk" onchange="addInQueHOD(this.value);getWorksListInIssuesReport();getStatusListInIssuesReport();getLocationsListInIssuesReport();getCategoriesListInIssuesReport();getTitlesListInIssuesReport();getIssueDetailsReport();">
	                                    ...
	                                    <div class="col s6 m4 l3 input-field">
	                                        ...
	                                        <select class="searchable validate-dropdown" id="work_id_fk" name="work_id_fk" onchange="addInQueWork(this.value);getContractsListInIssuesReport();getStatusListInIssuesReport();getLocationsListInIssuesReport();getCategoriesListInIssuesReport();getTitlesListInIssuesReport();getIssueDetailsReport();">
	                                            <option value="">Select </option>
	                                    ...
	                                    <div class="col s6 m4 l3 input-field">
	                                        ...
	                                        <select class="searchable validate-dropdown" id="contract_id_fk" name="contract_id_fk" onchange="addInQueContract(this.value);getStatusListInIssuesReport();getLocationsListInIssuesReport();getCategoriesListInIssuesReport();getTitlesListInIssuesReport();getIssueDetailsReport();">
	                                            <option value="">Select </option>
	                                            ...
	                                            <option value="">Select </option>
	                                             <c:forEach var="obj" items="${titlesList }">
                                                    <option work_id_fk="${obj.work_id_fk}" contract_id_fk="${obj.contract_id_fk}" status_fk="${obj.status_fk}"
                                                     hod_user_id_fk="${obj.hod_user_id_fk}" value="${obj.issue_id }">${obj.location} - ${obj.title }</option>
                                                </c:forEach>
	                                        </select>
      ...
      var filtersMap = new Object();
        ...
        function getContractsListInIssuesReport(contarct){
        	...
        	var hod_user_id_fk = $("#hod_user_id_fk").val();
           	...
           	$("#category_fk option:not(:first)").remove();
           	$("#issue_id option:not(:first)").remove();
           	var myParams = {hod_user_id_fk : hod_user_id_fk,work_id_fk : work_id_fk}
           	$.ajax({
                   ...
                   success: function (data) {
                       if (data.length > 0) {
                           $.each(data, function (i, val) {
                        	   ...
                        	   $("#issue_id").append('<option work_id_fk="'+$.trim(val.work_id_fk)+'" contract_id_fk="'+$.trim(val.contract_id_fk)+'" status_fk="'+$.trim(val.status_fk)+'" hod_user_id_fk="'+$.trim(val.hod_user_id_fk)+'" value="' + $.trim(val.issue_id) + '"'+selectedFlag+'>' + $.trim(val.location) +' - '+ $.trim(val.title) +'</option>');
                           });
                       }
                       $('.searchable').select2();
                       $(".page-loader").hide();
