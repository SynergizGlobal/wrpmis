                                ...
                                <div class="col m10 s12">
                                    <div class="row">
                                        ...
                                        <div class="col m12 s12 input-field">
                                            <p>Contract</p>
                                            <select id="contract_id_fk" name="contract_id_fk" class="searchable" onchange="getComponentIdsList();">
                                                <option value="">Select</option>
                                    ...
                                    <div class="row" id="toggle-selects">
                                        ...
                                        <div class="col m4 s12 input-field">
                                            <p>Structure</p>
                                            <select id="strip_chart_structure_id_fk" name="strip_chart_structure_id_fk" class="searchable" onchange="getComponentIdsList();">
                                                <option value="">Select</option>
                                                <c:forEach var="obj" items="${structuresList }">
                                                	<option value="${obj.strip_chart_structure }">${obj.strip_chart_structure}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                        <div class="col m4 s12 input-field">
                                            <p>Line</p>
                                            <select id="strip_chart_line_id_fk" name="strip_chart_line_id_fk" class="searchable" onchange="getComponentIdsList();">
                                                <option value="">Select</option>
                                                <c:forEach var="obj" items="${linesList }">
                                                	<option value="${obj.strip_chart_line }">${obj.strip_chart_line}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                        <div class="col m4 s12 input-field">
                                            <p>Section</p>
                                            <select id="strip_chart_section_id_fk" name="strip_chart_section_id_fk" class="searchable" onchange="getComponentIdsList();">
                                                <option value="">Select</option>
                                                <c:forEach var="obj" items="${sectionsList }">
                                                	<option value="${obj.strip_chart_section_id }">${obj.strip_chart_section_name}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row shop-tracking-status" style="margin-bottom: 20px;">
                                        <div class="col m12 s12 ">
                                    ...
                                    <div class="row">                                       
                                        <div class="col m4 s12 input-field">
                                            <p>Component</p>
                                            <select class="searchable" id="strip_chart_component_fk" name="strip_chart_component_fk">
                                            <option value="1">Option 1</option>
                                            </select>
                                        </div>
                                         <div class="col m4 s12 input-field">
                                            <p>Component ID</p>
                                            <select class="searchable" id="strip_chart_component_id_fk"  name="strip_chart_component_id_fk">
                                     ...
                                     <div class="row" style="margin-bottom:30px;margin-top:20px">
                                        <div class="col m3 s6 ">
                                            <div>Planned Start <span class="right">:</span> </div>
                                        </div>
                                        <div class="col m3 s6">
                                            <div>18/09/2020 </div>
                                        </div>
                                        <div class="col m3 s6 ">
                                            <div>Planned Finish <span class="right">:</span> </div>
                                        </div>
                                        <div class="col m3 s6 ">
                                            <div>18/09/2021 </div>
                                        </div>
                                    ...
                                    <div class="row" style="margin-bottom:30px">
                                        <div class="col m3 s6 ">
                                            <div>Scope <span class="right">:</span></div>
                                        </div>
                                        <div class="col m3 s6 ">
                                        	<div> scope</div>
                                        </div>
                                        <div class="col m3 s6 ">
                                            <div>Completed <span class="right">:</span> </div>
                                        </div>
                                        <div class="col m3 s6 ">
                                            <div>19/09/2020</div>
                                        </div>
