...
<body>
                        ...
                        <div class="row no-mar">
                            <div class="col s12 center-align">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Notification Type</a>
                            </div>
                        </div>
                        <div class="row no-mar">
                            <div class="col m12 s12">
                                <table id="notification_type_table" class="mdl-data-table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
										<c:forEach var="obj" items="${notificationTypeDetails.dList1}" varStatus="indexs">
											<tr><td>
												<input type="hidden" id="notification_typeId${indexs.count}" value="${obj.notification_type }"  class="findLengths"/>
    ...
    <div id="addUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/add-notification-type" id="notificationTypeForm" name="notificationTypeForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header">Add Notification Type <span class="right modal-action modal-close"><span
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m6">
                                <input id="notification_type" type="text" name="notification_type" class="validate" onkeyup="doValidate(this.value)">
                                <label for="notification_type">Notification Type</label>
                                <span id="notification_typeError" class="error-msg" ></span>
                            </div>
                            <div class="input-field col s12 m6">
                                <input id="notification_type_icon" type="text" name="notification_type_icon" class="validate">
                                <label for="notification_type_icon">Notification Type Icon</label>
                                <span id="notification_type_iconError" class="error-msg" ></span>
                            </div>
                        </div>
                        <div class="row">
    ...
    <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-notification-type" id="updateNotificationTypeForm" name="updateNotificationTypeForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header">Update Notification Type <span class="right modal-action modal-close" onclick="removeErrorMsg()"><span
                            class="material-icons">close</span></span></h5>
                <div class="row">
                    <div class="col m2 hide-on-small"></div>
                    <div class="col m8 s12">
...
<script src="/pmis/resources/js/dataTables.fixedColumns.min.js"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#notification_type_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
        ...
        function doValidate(value){
     	   ...
     	   while(count < validate){
     		   ...
     		   if(findVal == value){
     			   $('#notification_typeError').text(print_value+' alreday exists').css('color', 'red');
     			   $('#bttn').prop('disabled', true);
     			   flag = false;
     			   return false;
     		   }else{
     			   $('#notification_typeError').text('');
      ...
      $("#notificationTypeForm").submit(function (e) {
        	 if(validator.form()){ 
    			$(".page-loader").show();
    			$("#addUpdateModal").modal();
    			 if(flag){
      ...
      $("#updateNotificationTypeForm").submit(function (e) {
     	 if(validato1r.form()){ 
 			$(".page-loader").show();
        ...
        var validator = $('#notificationTypeForm').validate({
         	 rules: {
         		 "notification_type": {
     	        	 ...
     	        	 if(element.attr("id") == "notification_type" ){
     				     document.getElementById("notification_typeError").innerHTML="";
     			 	     error.appendTo('#notification_typeError');
     				 }else  if(element.attr("id") == "notification_type_icon" ){
     				     document.getElementById("notification_type_iconError").innerHTML="";
     			 	     error.appendTo('#notification_type_iconError');
     				 }
     	        }
         });
