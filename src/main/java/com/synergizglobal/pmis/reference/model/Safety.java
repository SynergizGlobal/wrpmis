...
public class Safety {
	...
	public String getUtility_alignment() {
		return utility_alignment;
	}

	public void setUtility_alignment(String utility_alignment) {
		this.utility_alignment = utility_alignment;
	}

	public String getUtility_category() {
		return utility_category;
	}

	public void setUtility_category(String utility_category) {
		this.utility_category = utility_category;
	}
