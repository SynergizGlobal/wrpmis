...
import com.synergizglobal.wrpmis.reference.Idao.RRTypeOfUseDao;
...
public class RRTypeOfUseDaoImpl implements RRTypeOfUseDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='rr_type_of_use' and s.name='dbo'\r\n" + 
	...
	public boolean updateRRTypeOfUse(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table rr_type_of_use NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table rr_type_of_use CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
