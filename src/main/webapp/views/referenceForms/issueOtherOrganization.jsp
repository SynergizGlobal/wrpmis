...
<head>
    ...
    <title>Issue Other Organization</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col m4 s12 center-align">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Other Organization</a>
                            </div>
                            <div class="col m4 hide-on-small"></div>
                        </div>
                        <div class="row no-mar">
                            <div class="col m12 s12">
                                <table id="other_organization_table" class="mdl-data-table">
                                    <thead>
                                        <tr>
    ...
    <script>
        $(document).ready(function () {
           ...
           /*  // adding table data into table start
            ...
            var table = $('#other_organization_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
        ...
        var validator =  $('#otherOrganizationForm').validate({
        	 rules: {
        		 "other_organization": {
 	        	 ...
 	        	 if(element.attr("id") == "other_organization" ){
        ...
        var validator1 =  $('#updateOtherOrganizationForm').validate({
          	 rules: {
          		 "value_new": {
    			 		  required: true
          		 }
