...
public class P6WbsCategoryDaoImpl implements P6WbsCategoryDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='p6_wbs_category' and s.name='dbo'\r\n" + 
	...
	public boolean updateP6WbsCategory(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table p6_wbs_category NOCHECK Constraint All";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table p6_wbs_category CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
