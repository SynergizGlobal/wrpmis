...
<head>
    ...
    <title>
    	 <c:if test="${action eq 'edit'}">Update Data Gathering - Update Forms - PMIS</c:if>
		 <c:if test="${action eq 'add'}"> Add Data Gathering - Update Forms - PMIS</c:if>
	</title>
                            ...
                            <div class="row">
                                <div class="col s6 m4 mt-brdr offset-m2">
                                    <div class="center-align m-1">
	                                         <c:if test="${action eq 'edit'}">
	                                           <button type="button" onclick="updateDataGatherigForm();" class="btn waves-effect waves-light bg-m">Update</button>
	                                         </c:if>
											 <c:if test="${action eq 'add'}"> 
						                       <button type="button" onclick="addDataGatherigForm();" class="btn waves-effect waves-light bg-m" style="min-width:90px">Add</button>
											 </c:if>
                                    </div>
                                </div>
                               <div class="col s6 m4 mt-brdr">
                                    <div class="center-align m-1">
                                          <a href="<%=request.getContextPath()%>/data-gathering" class="btn waves-effect waves-light bg-s ">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
