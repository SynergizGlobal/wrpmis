...
public class RRPhaseDaoImpl implements RRPhaseDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='rr_phase' and s.name='dbo'\r\n" + 
	...
	public boolean updateRRPhase(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table rr_phase NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table rr_phase CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
