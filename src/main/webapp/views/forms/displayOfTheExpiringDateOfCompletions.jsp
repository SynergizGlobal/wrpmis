					...
					<div class="card-content">
						<span class="card-title headbg">
							<div class="center-align bg-m p-2 m-b-5">
								<h6 class="mob-mar">List of Contracts Closer to DOC Expiry Date</h6>	
							</div>
						</span>
					</div>
...
<p style="margin: 0cm; font-size: 15px; font-family: 'Calibri',sans-serif; margin-top: 7.2pt; line-height: 200%;"><strong><span style="font-size: 14px; line-height: 200%; font-family: 'Arial',sans-serif; color: black;">Letter No. MRVC/ACCTS/CONTRACT/DOC/<u id="currentyeartext">2020-21</u></span></strong><strong><span style="font-size: 14px; line-height: 200%; font-family: 'Arial',sans-serif; color: black;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span></strong><strong><span style="font-size: 14px; line-height: 200%; font-family: 'Arial',sans-serif; color: black;">Date:&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;&shy;<span id="docdate2months"></span>&nbsp;</span></strong></p>
...
<p style="margin: 0cm; font-size: 15px; font-family: 'Calibri',sans-serif; margin-top: 7.2pt; line-height: 115%;"><strong><span style="font-size: 14px; line-height: 115%; font-family: 'Arial',sans-serif; color: black;">Date of completion for CA/ PO. No. MRVC/W/109/CA of <u id="docContractorName">M/S M VENKATA RAO INFRA PROJECTS PVT LTD</u></span></strong></p>
</td>
</tr>
</tbody>
</table>
<p><span style="height:30px;">&nbsp;</span></p>
<p style="margin: 6pt 9.7pt .0001pt 0cm; font-size: 15px; font-family: 'Calibri',sans-serif; text-align: justify; text-indent: 50.4pt; line-height: 115%;"><span style="font-size: 14px; line-height: 115%; font-family: 'Arial',sans-serif; color: black;">The stipulated date of completion for subject contract under execution by </span><strong><u><span style="font-size: 14px; line-height: 115%; font-family: 'Arial',sans-serif; color: black;" id="docContractorName1">VENKATA RAO INFRA PROJECTS PVT</span></u></strong><span style="font-size: 14px; line-height: 115%; font-family: 'Arial',sans-serif; color: black;">&nbsp;</span><span style="font-size: 14px; line-height: 115%; font-family: 'Arial',sans-serif; color: black;"> is <strong><u id="docExpiryDate">02-Sep-23</u></strong>. Advice may kindly be given to this office on further extension, if any, or else closure of work as per procedure.&nbsp;</span></p>
...
<p style="margin: 6pt 32.4pt .0001pt 0cm; font-size: 15px; font-family: 'Calibri',sans-serif;"><strong><u><span style="font-size: 14px; font-family: 'Arial',sans-serif; color: black;" id="docContractorAddress">VENKATA RAO INFRA PROJECTS PVT LTD,&nbsp;B-212, Western Edge-II, Behind Metro Mall, Borivali(E), Mumbai- 400066</span></u></strong></p>
    ...
    function export2Word( element,row,contract_id ) {

    	
		$.ajax({url : "<%=request.getContextPath()%>/ajax/get-contract-doc-details",type:"POST",data: {contract_id:contract_id},success : function(data){  
			...
			if(data != null && data != '' && data.length > 0)
			{
				$.each(data,function(key,val){
					...
					var SplitStr=val.doc;
					SplitStr=SplitStr.toString();
					var SplitStrwith=SplitStr.split("-");
					
					var dt = new Date(val.doc);
					
					
					var subdate=addDate(dt, -3, 'months');
					$("#docdate2months").html(convert(subdate));
					$("#docContractorName").html(val.contractor_name);
					$("#docContractorName1").html(val.contractor_name);
					$("#docExpiryDate").html(val.doc);
					$("#docContractorAddress").html(val.contractor_name+', '+val.address);
					 ...
					 var html, link, blob, url, css;
			    	   ...
			    	   link.href = url;
			    	   link.download = 'DOC Expiry Letter_'+val.contract_id;  // default name without extension 
			    	   document.body.appendChild(link);
			    	   if (navigator.msSaveOrOpenBlob ) navigator.msSaveOrOpenBlob( blob, 'DOC_Expiry_Letter.doc'); // IE10-11
    ...
    function getContractList(){
		...
		$.ajax({url : "<%=request.getContextPath()%>/ajax/generate-doc-contractual-letters",type:"POST",success : function(data){  
				if(data != null && data != '' && data.length > 0){
					var iteration=1;
	         		$.each(data,function(key,val){
	         			var actionsDownload ="";
	         			if(new Date(val.revised_doc)<new Date())
         				{
         			 		actionsDownload = '<a href="javascript:void(0);"  onclick=export2Word(window.docx,'+iteration+',"'+val.contract_id+'") class="btn waves-effect waves-light bg-s t-c" title="Download"><i class="fa fa-download"></i></a>';    
         				}
	         			else
         				{
         			 		actionsDownload = '<a href="javascript:void(0);"  onclick=export2Word(window.docx,'+iteration+',"'+val.contract_id+'") class="btn waves-effect waves-light bg-s t-c" title="Download"><i class="fa fa-download"></i></a>';    
	                   	...
	                   	var StatusArray="";
                   		if(val.doc_letter_status=="Submitted")
                   		{
	                   	...
	                   	var linkdoc="<a href='/wrpmis/get-contract/"+val.contract_id+"'>"+val.doc+"</a>";
    ...
    function updateLetterStatus(contractid,letter_status)
    {
        ...
        $.ajax({
            url: "<%=request.getContextPath()%>/ajax/UpdateDateOfCompletionLetterStatus",
