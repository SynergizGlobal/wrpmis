...
public class RROccupancyStatusDaoImpl implements RROccupancyStatusDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='rr_occupancy_status' and s.name='dbo'\r\n" + 
	...
	public boolean updateRROccupancyStatus(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table rr_occupancy_status NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table rr_occupancy_status CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
