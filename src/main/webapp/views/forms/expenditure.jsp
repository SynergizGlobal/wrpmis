...
<body>
            ...
            <div class="container">
               <form action="<%=request.getContextPath() %>/upload-expenditures" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row no-mar">
                        ...
                        <div class="col s12 m6 mt-brdr">
                            <div class="center-align m-1">
                                <button type="button" class="btn waves-effect waves-light bg-s" onclick="closeUploadExpendituresModal();">Cancel</button>
                            </div>
                        </div>
                    </div>
                </form>
 ...
 <div class="page-loader" style="display: none;">
    ...
    function clearFilter(){
    	...
    	window.location.href = "<%=request.getContextPath()%>/expenditure";
    		        ...
    		        "aoColumns": [
    		            ...
    		            { "mData": function(data,type,row){
    		         	...
    		         	{ "mData": function(data,type,row){
    	                    ...
    	                    var actions = '<a href="javascript:void(0);"  onclick="getExpenditure('+expenditure_id+');" class="btn waves-effect waves-light bg-m t-c mob-btn" ><i class="fa fa-pencil"></i></a>';
    		            	return actions;
    		            } }
