...
public class EMailSender {    
	...
	/*private static String mailId = "syntrack.building@gmail.com";
	private static String pass = "syntrack@123";*/
	...
	public static Session getSession() {
		...
		props.put("mail.smtp.host", "mail.residentxpress.com");
	...
	public void sendEmailWithDueActivities(Mail mail) throws Exception {
		try {
			  ...
			  velocityContext.put("dueActivities", mail.getDueActivities());
