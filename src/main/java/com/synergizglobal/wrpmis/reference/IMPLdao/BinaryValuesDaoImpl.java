...
public class BinaryValuesDaoImpl implements BinaryValuesDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='binary_values' and s.name='dbo'\r\n" + 
	...
	public boolean updateBinaryValues(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table binary_values NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table binary_values CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
