...
<body>
	                                ...
	                                <div class="row">	  
	                                	<div class="col s6 m4 l3 input-field">
	                                        <button class="btn bg-s waves-effect waves-light t-c clear-filters"
	                                            ...
	                                            onclick="generateTrainingReport()">Generate Report</button>
	                                    </div>                              	
    ...
    var filtersMap = new Object();
        ...
        function generateTrainingReport() {
        	//$(".page-loader").show();
        	$('#reportForm').attr('action', '<%=request.getContextPath() %>/generate-training-report').submit();
		}
        ...
        function clearFilter() {
        	  ...
        	  $('#end_time').val('');
        	  $('.searchable').select2();
        	  window.location.href = '<%=request.getContextPath() %>/training-report';
        	}
