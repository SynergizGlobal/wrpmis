...
public class ZonalRailwayFundDaoImpl implements ZonalRailwayFundDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='zonal_railway_funds' and s.name='dbo'\r\n" + 
	...
	public boolean updateZonalRailwayFund(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table zonal_railway_funds NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table zonal_railway_funds CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
