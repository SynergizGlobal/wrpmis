...
import com.synergizglobal.wrpmis.common.DocxTableCreationForAlertsReport;
...
@Controller
public class AlertsReportController {
	@InitBinder
    public void initBinder(WebDataBinder binder) {
        binder.registerCustomEditor(String.class, new StringTrimmerEditor(true));
    }
	
	public static Logger logger = Logger.getLogger(AlertsReportController.class);	
