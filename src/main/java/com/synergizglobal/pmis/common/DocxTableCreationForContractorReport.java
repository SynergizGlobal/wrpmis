		...
		try {
			...
			int temp = 1;
				...
				for (Contractor cObj1 : contractsData) 
				{
					...
					addTableCell(factory, wordMLPackage, contentRow, cObj1.getContractor_name(), garamondRPr,
							JcEnumeration.LEFT, hasBgColor, backgroundColor);
					addTableCell(factory, wordMLPackage, contentRow, cObj1.getPan_number(), garamondRPr, JcEnumeration.CENTER,
