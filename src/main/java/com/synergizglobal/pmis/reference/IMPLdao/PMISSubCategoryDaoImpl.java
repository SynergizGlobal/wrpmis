...
public class PMISSubCategoryDaoImpl implements PMISSubCategoryDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='pmis_sub_category' and s.name='dbo'\r\n" + 
	...
	public boolean updatePmisSubCategory(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table pmis_sub_category NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table pmis_sub_category CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
