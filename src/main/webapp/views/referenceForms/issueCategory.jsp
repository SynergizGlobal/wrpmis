...
<%-- <jsp:include page="../layout/header.jsp"></jsp:include> --%>
                        ...
                        <div class="row">
                            ...
                            <div class="col m4 s12 center-align">
                                <a class="waves-effect waves-light btn bg-m modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Issue Category</a>
                            </div>
                            <div class="col m4 hide-on-small"></div>
                        </div>
    ...
    <div id="addUpdateModal" class="modal">
		<form action="<%=request.getContextPath() %>/add-issue-category" id="addIssueCategoryForm" name="addIssueCategoryForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header">Add Issue Category <span class="right modal-action modal-close"><span
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="issue_category_text" name="category" type="text" class="validate">
                        ...
                        <div class="row">
                            <div class="col s12 m6">
                                <div class="center-align m-1">
                                    <button style="width: 100%;" onclick="addIssueCategory();"
    ...
    <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-issue-category" id=updateIssueCategoryForm name="updateIssueCategoryForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header bg-m">Update Issue Category <span class="right modal-action modal-close"><span
                            class="material-icons">close</span></span></h5>
                <div class="row">
                    <div class="col m2 hide-on-small"></div>
                    <div class="col m8 s12">
                       <div class="row no-mar">
                         <div class="input-field col s12 m12">
                                ...
                                <label for="value_new">Issue Category</label>
                        ...
                        <div class="row">
                            <div class="col s12 m6">
                                <div class="center-align m-1">
                                    <button style="width: 100%;" onclick="updateIssueCategory()"
    ...
    <script>
        $(document).ready(function () {
          ...
          /*   // adding table data into table start
            var arr = ['Construction', 'Contract', 'Contractor', 'Data', 'Drawing', 'Force Majeure', 'Front Availability', 'Funding', 'Land', 'Material', 'Others', 'Permission', 'Utility'];
            var table_text = '';
            ...
            $('#issue_category_table tbody').append(table_text);
