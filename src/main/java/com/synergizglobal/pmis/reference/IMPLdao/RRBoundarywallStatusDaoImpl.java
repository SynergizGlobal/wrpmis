...
public class RRBoundarywallStatusDaoImpl implements RRBoundarywallStatusDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='rr_boundarywall_Status' and s.name='dbo'\r\n" + 
	...
	public boolean updateRRBoundarywallStatus(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table rr_boundarywall_Status NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table rr_boundarywall_Status CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
