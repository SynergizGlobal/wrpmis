...
import com.synergizglobal.wrpmis.reference.Idao.DesignResponsibleExecutivesDao;
	...
	public List<TrainingType> getExecutivesDetails(TrainingType obj) throws Exception {
	    ...
	    try {
	        String qry =
	            ...
	            "   re.project_id_fk, " +
	            "   p.project_name, " +
	            "   STRING_AGG(u.user_name, ',') AS user_name, " +
	            "   STRING_AGG(CAST(u.user_id AS VARCHAR), ',') AS user_id " +
	            ...
	            "GROUP BY re.project_id_fk, p.project_short_name";
