...
public class RRTenureStatusDaoImpl implements RRTenureStatusDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='rr_tenure_status' and s.name='dbo'\r\n" + 
	...
	public boolean updateRRTenureStatus(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table rr_tenure_status NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table rr_tenure_status CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
