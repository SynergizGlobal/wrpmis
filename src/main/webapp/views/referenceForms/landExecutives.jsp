...
<head>
    ...
    <title>Land Acquisition Executives</title>
...
<body>
                ...
                <div class="card-content">
                    <span class="card-title headbg">
                        <div class="center-align bg-m p-2 m-b-5"> 
                            <h6>Land Acquisition Executives</h6>
                        </div>
                    </span>
                    ...
                    <div class="">
                        ...
                        <div class="row no-mar">
                            <div class="col m12 s12">
                                <table id="land_executives_table" class="mdl-data-table">
                                    <thead>
                                        <tr>
                                            <th>Work</th>
                                            <th>Executives</th>
                                    ...
                                    <c:forEach var="obj" items="${executivesDetails}" varStatus="indexs">
											<tr>
											<td>
												<input type="hidden" id="land_work_id_fk${indexs.count}" value="${obj.work_id_fk }" /> 
												${obj.work_short_name }</td>
											<td>
												<input type="hidden" id="land_user_id${indexs.count}" value="${obj.user_id }" /> 
												${obj.user_name }</td>
   ...
   <div class="page-loader" style="display: none;">
    ...
    <div id="addUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/add-land-executives" id="addRrExecutivesForm" name="addRrExecutivesForm" method="post" class="form-horizontal" role="form">
                        		...
                        		<div class="row">
		                            ...
		                            <div class="col s12 m6">
		                                <div class="center-align m-1">
		                                         ...
		                                         <a href="<%=request.getContextPath()%>/land-executives"
     ...
     <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-land-executives" id=updateRrExecutivesForm name="updateRrExecutivesForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
...
<%-- <jsp:include page="../layout/footer.jsp"></jsp:include> --%>
	<form name="getForm" id="getForm" method="post">
    	<input type="hidden" name="land_sub_location" id="id" />
    </form>
    ...
    <script>
        $(document).ready(function () {
          ...
          /*   
            ...
            var table = $('#land_executives_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
    ...
    /*    var validator = $('#addRrExecutivesForm').validate({
        ignore: ":hidden:not(.validate-dropdown)",
      	 rules: {
  	        ...
  	        },elandorPlacement:function(elandor, element){
  	        	 if(element.attr("id") == "land_location_fk" ){
  				     document.getElementById("land_location_fkElandor").innerHTML="";
  			 	     elandor.appendTo('#land_location_fkElandor');
  			   }else if(element.attr("id") == "land_sub_location" ){
  				     document.getElementById("land_sub_locationElandor").innerHTML="";
  			 	     elandor.appendTo('#land_sub_locationElandor');
  			   }
  	        }
       });
       ...
       var validator1 = $('#updateRrExecutivesForm').validate({
           ignore: ":hidden:not(.validate-dropdown)",
         	 rules: {
     	        	 ...
     	        	 if(element.attr("id") == "land_location_fk_new" ){
     				     document.getElementById("land_location_fk_newElandor").innerHTML="";
     			 	     elandor.appendTo('#land_location_fk_newElandor');
     			   }else if(element.attr("id") == "value_new" ){
     				     document.getElementById("value_newElandor").innerHTML="";
     			 	     elandor.appendTo('#value_newElandor');
     			   }
     	        }
          }); */
      ...
      function updateRow(no) {
          ...
          var work_id_fk = $('#land_work_id_fk'+no).val();
         $('#work_id_fk_old').val(work_id_fk);
          var user_id = $('#land_user_id'+no).val();
