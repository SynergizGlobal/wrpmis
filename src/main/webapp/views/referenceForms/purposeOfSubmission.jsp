...
<head>
    ...
    <title>Purpose of Submission</title>
...
<body>
                        ...
                        <div class="row no-mar">
                            <div class="col m4 s12 center-align offset-m4">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Purpose of Submission</a>
                            </div>
                        </div>
                        <div class="row no-mar">
    ...
    <div id="addUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/add-purpose-of-submission" id="addPurposeOfSubmissionForm" name="addPurposeOfSubmissionForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h4 class="modal-header">Add Purpose of Submission <span class="right modal-action modal-close"><span
                            ...
                            <div class="col s6 m6">
                                <div class="center-align m-1">
                                  <!--   <button
                                        ...
                                        <a href="<%=request.getContextPath()%>/purpose-of-submission"
     ...
     <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-purpose-of-submission" id=updatePurposeOfSubmissionForm name="updatePurposeOfSubmissionForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header bg-m">Update Purpose of Submission <span class="right modal-action modal-close" onclick="removeErrorMsg()"><span
...
<script src="/pmis/resources/js/dataTables.fixedColumns.min.js"></script>
	...
	<script src="/pmis/resources/js/sweetalert-v.1.1.0.min.js"></script>
      <script>
        ...
        $("#addPurposeOfSubmissionForm").submit(function (e) {
         	 if(validator.form()){ 
     			$(".page-loader").show();
     			$("#addUpdateModal").modal();
     			if(flag){
    				document.getElementById("addPurposeOfSubmissionForm").submit();	
    			 }
    			 $(".page-loader").hide();
    			 return false;
          }
       })
        $("#updatePurposeOfSubmissionForm").submit(function (e) {
       	 if(validator1.form()){ 
   			$(".page-loader").show();
   			$("#addUpdateModal").modal();
   			if(updateFlag){
 				document.getElementById("updatePurposeOfSubmissionForm").submit();	
 			 }
 			 $(".page-loader").hide();
 			 return false;
        }
         	...
         	swal({
    	            ...
    	            if (isConfirm) {
    	               // swal("Deleted!", "Record has been deleted", "success");
    	                $(".page-loader").show();
    	            	$('#getForm').attr('action', '<%=request.getContextPath()%>/delete-purpose-of-submission');
    	    	    	$('#getForm').submit();
    	           }else {
