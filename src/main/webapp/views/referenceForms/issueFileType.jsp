    ...
    <script>
        $(document).ready(function () {
           ...
           /*  // adding table data into table start
            ...
            var table = $('#issue_file_type_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
        ...
        function doValidate(value){
     	   ...
     	   while(count < validate){
     		   ...
     		   if(findVal == value){
     			   $('#issue_file_typeError').text(print_value+' alreday exists').css('color', 'red');
     			   $('#bttn').prop('disabled', true);
     			   flag = false;
     			   return false;
     		   }else{
     			   $('#issue_file_typeError').text('');
        ...
        $("#addIssueFileTypeForm").submit(function (e) {
         	 if(validator.form()){ 
     			$(".page-loader").show();
     			$("#addUpdateModal").modal();
     			 if(flag){
        				document.getElementById("addIssueFileTypeForm").submit();	
        			 }
        			 $(".page-loader").hide();
        			 return false;
            }
        })
        $("#updateIssueFileTypeForm").submit(function (e) {
         	 if(validator1.form()){ 
     			$(".page-loader").show();
     			$("#onlyUpdateModal").modal();
     			 if(updateFlag){
        				document.getElementById("updateIssueFileTypeForm").submit();	
        			 }
        			 $(".page-loader").hide();
        			 return false;
            }
        })
        var validator =  $('#addIssueFileTypeForm').validate({
        	 rules: {
        		 "issue_file_type": {
 			 		  required: true 
        		 }
 	        	 ...
 	        	 if(element.attr("id") == "issue_file_type" ){
 				     document.getElementById("issue_file_typeError").innerHTML="";
 			 	     error.appendTo('#issue_file_typeError');
 				 }
 	        }
        	
        });
        
        var validator1 =  $('#updateIssueFileTypeForm').validate({
          	 rules: {
          		 "value_new": {
    			 		  required: true
          		 }
