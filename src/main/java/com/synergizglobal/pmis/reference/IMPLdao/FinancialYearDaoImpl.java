...
public class FinancialYearDaoImpl implements FinancialYearDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='financial_year' and s.name='dbo'\r\n" + 
	...
	public boolean updateFinancialYear(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table financial_year NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table financial_year CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
