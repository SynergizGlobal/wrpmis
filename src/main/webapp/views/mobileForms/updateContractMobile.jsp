                        ...
                        <form action="<%=request.getContextPath() %>/update-contract" id="contractForm" name="contractForm" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
							<div class="container container-no-margin">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col s12 m4 input-field mb-sm">
                                ...
                                <div class="table-inside">
                                    <table id="bankTable" class="mdl-data-table mobile_responsible_table">
                                        ...
                                        <c:when test="${not empty contractDeatils.bankGauranree && fn:length(contractDeatils.bankGauranree) gt 0 }">
                                		  ...
                                		  <c:forEach var="bankObj" items="${contractDeatils.bankGauranree }" varStatus="index">                                        	
                                            ...
                                            <tr id="bankRow${index.count }">
                                                <td data-head="BG Type"> <select id="bg_type_fks${index.count }" name="bg_type_fks" class="searchable">
                                                        <option value="">Select</option>
                                                ...
                                                <td data-head="BG Value" class="input-field"><i class="material-icons prefix center-align">₹</i>
                                             ...
                                             <c:otherwise>
                                             <tr id="bankRow0">
                                                <td data-head="BG Type"> <select id="bg_type_fks0" name="bg_type_fks" class="searchable">
                                                        <option value="" selected>Select </option>
                                                         <c:forEach var="obj" items="${bankGuaranteeTYpe }">
                                     ...
                                     <table class="mdl-data-table">
                                        <tbody id="bankTableBody">                                          
                                            <tr class="mobile_row_hide">
									 <td colspan="9" class="mobile_btn_add"> <a   class="btn waves-effect waves-light bg-m t-c "  onclick="addBankRow()"> <i
                            ...
                            <div class="row fixed-width" id="insurance_div">
                                ...
                                <div class="table-inside">
                                    <table id="insurenceTable" class="mdl-data-table mobile_responsible_table">
                                        <thead>
                                            <tr>
                                     ...
                                     <table  class="mdl-data-table">
                                        <tbody id="insurenceTableBody">                                          
                                            <tr class="mobile_row_hide">
                                   <td colspan="8" class="mobile_btn_add" ><a   class="btn waves-effect waves-light bg-m t-c "  onclick="addInsurenceRow()"> <i class="fa fa-plus"></i></a></td>
                                             </tr>
                                        </tbody>
                                    </table>
									<c:choose>
	                            ...
	                            <div class="row fixed-width">
	                                ...
	                                <div class="table-inside">
	                                    ...
	                                    <table class="mdl-data-table">
	                                        <tbody id="milestoneTableBody">                                          
	                                            <tr class="mobile_row_hide">
	  										<td colspan="6" class="mobile_btn_add" ><a type="button"  class="btn waves-effect waves-light bg-m t-c "  onclick="addMilestoneRow()"> <i
	                                                            class="fa fa-plus"></i></a></td> 
	                                             </tr>
	                                        </tbody>
	                                    </table>
                                ...
                                <div class="table-inside">
                                    ...
                                    <table id="ravTable" class="mdl-data-table mobile_responsible_table">
                                        ...
                                        <c:when test="${not empty contractDeatils.contract_revision  && fn:length(contractDeatils.contract_revision ) gt 0 }">
                                         ...
                                         <c:forEach var="revObj" items="${contractDeatils.contract_revision }" varStatus="index">  
                                            <tr id="revRow${index.count }">
                                                <td data-head="Revision Number"> <input id="revision_numbers${index.count }" name="revision_numbers" type="text" class="validate" value="${revObj.revision_number }"
                                             ...
                                             <c:otherwise>
                                             <tr id="revRow0">
                                                <td data-head="Revision Number"> <input id="revision_numbers0" name="revision_numbers" type="text" class="validate" 
                                                        placeholder="Revision Number">
                                                </td>
                                                <td data-head="Revised Amount" class="input-field"><i class="material-icons prefix center-align">₹</i>
                                     ...
                                     <table class="mdl-data-table">
                                        <tbody id="revTableBody">                                          
                                            <tr class="mobile_row_hide">
									<td colspan="5" class="mobil_btn_add">	<a type="button"  class="btn waves-effect waves-light bg-m t-c "  onclick="addRevRow()"> <i
                                                            class="fa fa-plus"></i></a></td>
                                              </tr>
                                        </tbody>
                                    </table>
	                                ...
	                                <div class="row fixed-width">
	                                    ...
	                                    <div class="table-inside">
			                                        ...
			                                        <c:when test="${not empty contractDeatils.contractKeyPersonnels  && fn:length(contractDeatils.contractKeyPersonnels ) gt 0 }">			                                          
				                                        <c:forEach var="keyObj" items="${contractDeatils.contractKeyPersonnels }" varStatus="index">  
			                                                <tr id="keyPersonnelRow${index.count }">
			                                                    <td data-head="Name"> <input id="contractKeyPersonnelNames${index.count }" name="contractKeyPersonnelNames" type="text" value="${keyObj.name }" class="validate" placeholder="Name">
			                                                    </td>
	                                             	...
	                                             	<c:otherwise>
	                                             		<tr id="keyPersonnelRow0">
		                                                    <td data-head="Name"> <input id="contractKeyPersonnelNames0" name="contractKeyPersonnelNames" type="text" class="validate" placeholder="Name">
		                                                    </td>
		                                                    <td data-head="Mobile No">
	                                        ...
	                                        <table class="mdl-data-table">
		                                        <tbody id="revTableBody">                                          
		                                            <tr class="mobile_row_hide">
														<td colspan="4" class="mobil_btn_add">	<a type="button"  class="btn waves-effect waves-light bg-m t-c "  onclick="addKeyPersonnelRow()"> <i
		                                                            class="fa fa-plus"></i></a></td>
		                                              </tr>
		                                        </tbody>
		                                     </table>
	                                ...
	                                <div class="row fixed-width">
	                                    ...
	                                    <div class="table-inside">
			                                        ...
			                                        <c:when test="${not empty contractDeatils.contractDocuments  && fn:length(contractDeatils.contractDocuments ) gt 0 }">			                                          
				                                        <c:forEach var="docObj" items="${contractDeatils.contractDocuments }" varStatus="index">  
			                                                <tr id="contractDocumentRow${index.count }">
			                                                    <td data-head="Name"> <input id="contractDocumentNames${index.count }" name="contractDocumentNames" type="text" class="validate"
	                                             	...
	                                             	<c:otherwise>
	                                             		<tr id="contractDocumentRow0">
		                                                    <td data-head="Name"> <input id="contractDocumentNames0" name="contractDocumentNames" type="text" class="validate"
		                                                            placeholder="Name">
		                                                    </td>
		                                                    <td data-head="Attachment" class="mobile_full_width">
		                                                        <div class="normal-btn mobile_file">
	                                        ...
	                                        <table class="mdl-data-table">
		                                        <tbody id="revTableBody">                                          
		                                            <tr class="mobile_row_hide">
														<td colspan="3" class="mobil_btn_add">	<a type="button"  class="btn waves-effect waves-light bg-m t-c "  onclick="addContractDocumentRow()"> <i
		                                                            class="fa fa-plus"></i></a></td>
		                                              </tr>
		                                        </tbody>
		                                     </table>
 ...
 <div class="page-loader" style="display: none;">
    ...
    <script>
        ...
        function addBankRow(){
		          ...
		          var total = 0;
		          var html = '<tr id="bankRow'+rNo+'"><td data-head="BG Type"> <div>'
		...
		function addInsurenceRow(){
		    ...
		    var rNo = Number(rowNo)+1;
		    console.log(rNo)
		    var html = '<tr id="insurenceRow'+rNo+'"><td data-head="Insurance Type"> <div>'
