...
<body>
                        ...
                        <div class="row no-mar">
                            <div class="col s12 center-align">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Revision Status</a>
                            </div>
                        </div>
                        <div class="row no-mar">
                            <div class="col m12 s12">
                                <table id="revision_status_table" class="mdl-data-table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
										<c:forEach var="obj" items="${revisionStatusDetails.dList1}" varStatus="indexs">
											<tr><td>
												<input type="hidden" id="revision_statusId${indexs.count}" value="${obj.revision_status }"  class="findLengths"/>
    ...
    <div id="addUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/add-revision-status" id="addRevisionStatusForm" name="addRevisionStatusForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header">Add Revision Status <span class="right modal-action modal-close"><span
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="revision_status_text" type="text" name="revision_status" class="validate" onkeyup="doValidate(this.value)">
                                <label for="revision_status_text">Revision Status</label>
                                <span id="revision_statusError" class="error-msg" ></span>
                            </div>
                        </div>
                        <div class="row">
     ...
     <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-revision-status" id=updateRevisionStatusForm name="id=updateRevisionStatusForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header bg-m">Update Revision Status <span class="right modal-action modal-close" onclick="removeErrorMsg()"><span
                            class="material-icons">close</span></span></h5>
                <div class="row">
                    <div class="col m2 hide-on-small"></div>
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                               <input id="value_new" type="text" name="value_new" class="validate" onkeyup="doValidateUpdate(this.value)">
                                ...
                                <label for="value_new">Revision Status</label>
...
<script src="/pmis/resources/js/dataTables.fixedColumns.min.js"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#revision_status_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
        ...
        function doValidate(value){
     	   ...
     	   while(count < validate){
     		   ...
     		   if(findVal == value){
     			   $('#revision_statusError').text(print_value+' alreday exists').css('color', 'red');
     			   $('#bttn').prop('disabled', true);
     			   flag = false;
     			   return false;
     		   }else{
     			   $('#revision_statusError').text('');
    ...
    $("#addRevisionStatusForm").submit(function (e) {
       	 if(validator.form()){ 
   			$(".page-loader").show();
    ...
    $("#updateRevisionStatusForm").submit(function (e) {
     	 if(validator1.form()){ 
 			$(".page-loader").show();
 			$("#addUpdateModal").modal();
 			 if(updateFlag){
    ...
    var validator = $('#addRevisionStatusForm').validate({
    	 rules: {
    		 "revision_status": {
	        	 ...
	        	 if(element.attr("id") == "revision_status_text" ){
