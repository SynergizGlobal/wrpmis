...
<head>
	<meta charset="UTF-8">
	<title>Daily Progress Report - Reports - PMIS</title>
		...
		<div class="col s12 m12">
			<div class="card ">
				<div class="card-content">
					...
					<!-- form start-->
					<form action="<%=request.getContextPath() %>/generate-newline-daily-progress-report" id="activitiesReportForm" name="activitiesReportForm" method="post" target="_blank">
						<div class="row">
	...
	<script>
      ...
      let date_pickers = document.querySelectorAll('.datepicker');
        ...
        function clearFilters(){
        	...
        	window.location.href= "<%=request.getContextPath()%>/newline-daily-progress-report";
        }
