...
public class DataGatheringRefrenceDaoImpl implements DataGatheringsDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='data_gathering_status' and s.name='dbo'\r\n" + 
	...
	public boolean updateDataGatheringStatus(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table data_gathering_status NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table data_gathering_status CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
