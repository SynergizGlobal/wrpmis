...
<head>
    ...
    <link rel="stylesheet" href="/wrpmis/resources/css/extension-grid.css">
    <style>
...
<!--                     <div class="container container-no-margin"> -->
                        <form action="add-contract" id="contractForm" name="contractForm" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                            <div class="container container-no-margin">
	                            <div class="row">
	                                <!-- row 1  -->
	                               <!--  <div class="col m2 hide-on-small-only hide-on-large-only"></div> -->
	                                <div class="col s12 m12 l12 xxl12">
	                                	<div class='row'>
	                                		 <div class="col s12 m4 l4 xxl3 input-field offset-l2 offset-m2">
	                                <p class="searchable_label">Project <span class="required">*</span></p>
	                                    <select class="searchable validate-dropdown" id="project_id_fk" name="project_id_fk" >
	                                     ...
	                                     <span id="project_id_fkError" class="error-msg" ></span>
	                                        ...
	                                        <div class="col s12 m4 l4 xxl3 input-field">
 ...
 <div class="page-loader" style="display: none;">
    ...
    <script>
        ...
        $(document).ready(function () {
             ...
             /*    $('name="revision_statuss"').change(function() {
                 if($(this).is(":checked")) {
                     var returnVal = confirm("Are you sure?");
                     $(this).attr("checked", returnVal);
                 } 
            	 revisionDetailsChecking();
             });*/
   ...
   function addBankRow(){
	...
	$('input[id^=revision_status]').change(function() {      
   	 console.log($(this));
		revisionDetailsChecking();
	});

	function revisionDetailsChecking(a){
		//console.log('current element= '+a +"  and "+$(a))
		var amounts=$('input[name^="revised_amounts"]');
		var docs=$('input[name^="revised_docs"]');
		console.log(amounts);
		console.log(docs);
