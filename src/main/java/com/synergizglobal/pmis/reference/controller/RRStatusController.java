...
public class RRStatusController {
	...
	@RequestMapping(value="/rr-status",method={RequestMethod.GET,RequestMethod.POST})
	public ModelAndView rrStatus(HttpSession session,@ModelAttribute TrainingType obj){
		ModelAndView model = new ModelAndView(PageConstants.rrStatus);
		try {
	...
	@RequestMapping(value = "/add-rr-status", method = {RequestMethod.POST})
	@ResponseBody
	public ModelAndView addRRStatus(@ModelAttribute Safety obj,RedirectAttributes attributes){
		ModelAndView model = new ModelAndView();
		try{
			model.setViewName("redirect:/rr-status");
	...
	@RequestMapping(value = "/update-rr-status", method = {RequestMethod.POST})
	@ResponseBody
	...
	@RequestMapping(value = "/delete-rr-status", method = {RequestMethod.POST})
	@ResponseBody
