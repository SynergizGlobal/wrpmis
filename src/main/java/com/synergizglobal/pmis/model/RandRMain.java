...
residential_salary_units,created_by_user_id_fk,modified_by,modified_date,user_id,user_name,designation,user_type_fk,user_role_code,executive_user_id_fk,rr_data_id, uploaded_file, status, uploaded_by_user_id_fk, uploaded_on,mail_body_header,
 ...
 approval_by_mrvc_responsible_person, report_submission_date_to_mrvc, approval_date_by_mrvc,res_user_id;
...
public void setBses_email(String bses_email) {
	this.bses_email = bses_email;
}

public String getRr_agency_id_fk() {
	return rr_agency_id_fk;
}

public void setRr_agency_id_fk(String rr_agency_id_fk) {
	this.rr_agency_id_fk = rr_agency_id_fk;
}
...
public void setName_of_representative(String name_of_representative) {
...
public String[] getName_of_representatives() {
	return name_of_representatives;
}

public void setName_of_representatives(String[] name_of_representatives) {
	this.name_of_representatives = name_of_representatives;
}

public String[] getDate_of_appointments() {
	return date_of_appointments;
}

public void setDate_of_appointments(String[] date_of_appointments) {
	this.date_of_appointments = date_of_appointments;
}
...
public String getRrbses_id() {
	return rrbses_id;
}

public void setRrbses_id(String rrbses_id) {
	this.rrbses_id = rrbses_id;
}

public String getRes_designation() {
	return res_designation;
}

public void setRes_designation(String res_designation) {
	this.res_designation = res_designation;
}
...
public String getMrvc_responsible_person() {
	return mrvc_responsible_person;
}

public void setMrvc_responsible_person(String mrvc_responsible_person) {
	this.mrvc_responsible_person = mrvc_responsible_person;
}

public String getBses_agency_name() {
	return bses_agency_name;
}

public void setBses_agency_name(String bses_agency_name) {
	this.bses_agency_name = bses_agency_name;
}

public String getAgency_responsible_person() {
	return agency_responsible_person;
}

public void setAgency_responsible_person(String agency_responsible_person) {
	this.agency_responsible_person = agency_responsible_person;
}
...
public String getSubmission_date_report_ca() {
	return submission_date_report_ca;
}

public void setSubmission_date_report_ca(String submission_date_report_ca) {
	this.submission_date_report_ca = submission_date_report_ca;
}

public String getActual_submission_date_bses_report_to_mrvc() {
	return actual_submission_date_bses_report_to_mrvc;
}

public void setActual_submission_date_bses_report_to_mrvc(String actual_submission_date_bses_report_to_mrvc) {
	this.actual_submission_date_bses_report_to_mrvc = actual_submission_date_bses_report_to_mrvc;
}

public String getApproval_by_mrvc_responsible_person() {
	return approval_by_mrvc_responsible_person;
}

public void setApproval_by_mrvc_responsible_person(String approval_by_mrvc_responsible_person) {
	this.approval_by_mrvc_responsible_person = approval_by_mrvc_responsible_person;
}

public String getReport_submission_date_to_mrvc() {
	return report_submission_date_to_mrvc;
}

public void setReport_submission_date_to_mrvc(String report_submission_date_to_mrvc) {
	this.report_submission_date_to_mrvc = report_submission_date_to_mrvc;
}

public String getApproval_date_by_mrvc() {
	return approval_date_by_mrvc;
}

public void setApproval_date_by_mrvc(String approval_date_by_mrvc) {
	this.approval_date_by_mrvc = approval_date_by_mrvc;
}

public List<RandRMain> getRrBSESLIst() {
	return rrBSESLIst;
}

public void setRrBSESLIst(List<RandRMain> rrBSESLIst) {
	this.rrBSESLIst = rrBSESLIst;
}
