                    ...
                    <div class="center-align">
                        <span class="card-title headbg">
                            <div class="center-align p-2 bg-m">
                                <h6>Update Land Acquisition type 4</h6>
                            </div>
                        </span>
                    </div>
                    <!-- form start-->
                    <div class="container container-no-margin">
                        <form action="<%=request.getContextPath() %>/update-land-acquisition-3" id="updateForm" name="updateForm" method="post">
...
<!-- update and back buttons starts -->
                            <div class="row">
                                ...
                                <div class="col s12 m4">
                                    <div class="center-align m-1">
                                        <a href="<%=request.getContextPath() %>/land-acquisition-3" class="btn waves-effect waves-light bg-s"
