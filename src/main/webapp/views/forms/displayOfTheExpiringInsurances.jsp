...
<table style='margin-left:50in;'><tr style='height:1pt;mso-height-rule:exactly'>
    ...
    <td>
      <div style='mso-element:footer' id=f1>
        <p class=headerFooter>
       <span style="font-size: 14px; line-height: 115%; font-family: 'Century Gothic',sans-serif; color: black;"><br><img style="width: 767px; height: 60.9686px;" src="https://i.postimg.cc/0QMbtk6h/img169346494879.png" width="767" height="60.9686"></span>
					...
					var iteration=1;
	         		$.each(data,function(key,val){
	         			...
	         			else
         				{
	                   	...
	                   	var insurancelink="<a href='/wrpmis/get-contract/"+val.contract_id+"'>"+val.insurance_number+"</a>";
