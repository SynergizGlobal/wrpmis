	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>${obj.activeStatus }
	                                            	<c:if test="${obj.activeStatus ne 'Completed' }">
	                                            	 <a onclick="updateLAStatus('${obj.landAcquisitionId}','${obj.activeStatus}')" class="waves-effect waves-light modal-trigger" style="cursor: pointer;">
...
<!-- card ending -->
    ...
    <div id="la_status_update" class="modal">
        <div class="modal-content">
            ...
            <!-- form start-->
            <div class="container">
               <form action="<%=request.getContextPath() %>/update-land-acquisition-status" id="updateForm" name="updateForm" method="post">
  ...
  <form action="<%=request.getContextPath()%>/get-land-acquisition-1" id="getForm" name="getForm" method="post">
