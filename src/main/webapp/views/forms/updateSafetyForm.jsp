                        ...
                        <form action="<%=request.getContextPath() %>/update-safety" id="safetyForm" name="safetyForm" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col s12 m12 l12 input-field">                                   
                                      <textarea id="title" name="title" class="pmis-textarea validate" data-length="100" maxlength="100">${safety.title }</textarea>
                            ...
                            <div class="row">
                                  <div class="col s12 m12 l12 input-field">
									  <textarea id="description" name="description" class="validate pmis-textarea" data-length="1000" maxlength="1000">${safety.description }</textarea>                                            
