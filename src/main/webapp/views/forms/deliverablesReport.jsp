            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="center-align m-1 close-message">${error}</div>
			            <form action="<%=request.getContextPath() %>/generate-deliverables-report" id="reportForm" name="reportForm" method="post" target="_blank">	                              
                                ...
                                <div class="col s6 m4 l2 input-field">
                                	 <p class="searchable_label" style="margin: 0 0 0px;text-align: left;"> Work</p>
                            ...
                            <div class="row">	                                	
                                <div class="col s7 m4 l3 input-field center-align offset-l3 offset-m2">
                                    <button type="button" class="btn bg-m waves-effe ct waves-light t-c clear-filters"
                                        style="margin-top: 6px;min-width:160px%; font-weight: 600;" onclick="downloadReport();">Download report</button>
                                </div>
                                <div class="col s5 m4 l3 input-field left-align ">
                                    <a class="btn bg-s waves-effect waves-light t-c" type="button"
                                        ...
                                        href="<%=request.getContextPath()%>/deliverables-report">Reset</a>
                                </div>                                
                             </div>
                        </form>
                        </div>
