...
<head>
    ...
    <title>Work Salient Features</title>
...
<body>
                    ...
                    <div class="">
                        ...
                        <div class="row plr-1">
                            <div class="col s12 m4 offset-m4 center-align" style="margin-bottom:20px;">
                                 <a href="<%=request.getContextPath() %>/add-work-salient-features-form" class="btn waves-effect waves-light bg-s t-c">
                        ...
                        <div class="row no-mar">
                            ...
                            <div class="col s12 m3 l2 input-field">
                               ...
                               <select id="search_work_id_fk" class="searchable" name="work_id_fk" onchange="getWorkSalientFeatures();">
                        ...
                        <div class="row">
                            <div class="col m12 s12">
                                <table id="data_table_work_salient_features" class="mdl-data-table">
                                    <thead>
                                        <tr>
                                            <th class="no-sort fw-250">Category</th>
    ...
    <form action="<%=request.getContextPath() %>/get-work-salient-features" id="getForm" name="getForm" method="post" >
    ...
    <script>
        ...
        function getWorkSalientFeatures(){
        	$(".page-loader-2").show();
        	
        	var work_id_fk = $("#search_work_id_fk").val();

        	table = $('#data_table_work_salient_features').DataTable();
    		...
    		table.state.clear();	
    	 	...
    	 	$.ajax({url : "<%=request.getContextPath()%>/ajax/getWorkSalientFeatures",type:"POST",data:myParams,success : function(data){    
    			...
    			if(data != null && data != '' && data.length > 0){    					
             		$.each(data,function(key,val){
                        ...
                        rowArray.push(val.category_fk);
                       	rowArray.push(val.work_short_name);
                       	rowArray.push(val.description);
