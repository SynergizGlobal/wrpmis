...
<head>
    ...
    <title>RR Boundary Wall Status</title>
...
<body>
                        ...
                        <div class="row no-mar">
                            <div class="col s12 center-align">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Boundary Wall Status</a>
                            </div>
                        </div>
                        <div class="row no-mar">
                            <div class="col m12 s12">
                                <table id="rr_boundary_wall_table" class="mdl-data-table">
                                    <thead>
                                        <tr>
    ...
    <div id="addUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/add-rr-boundary-wall-status" id="addBoundaryWallStatusForm" name="addBoundaryWallStatusForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h6 class="modal-header">Add Boundary Wall Status <span class="right modal-action modal-close"><span
                             ...
                             <div class="col s12 m6">
                                <div class="center-align m-1">
                                  <!--   <button
                                        ...
                                        <a href="<%=request.getContextPath()%>/rr-boundary-wall-status"
     ...
     <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-rr-boundary-wall-status" id=updateBoundaryWallStatusForm name="updateBoundaryWallStatusForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h6 class="modal-header bg-m">Update  Boundary Wall Status <span class="right modal-action modal-close"><span
                            class="material-icons">close</span></span></h6>
                <div class="row">
                    <div class="col m8 s12 offset-m2">
                       <div class="row no-mar">
                         <div class="input-field col s12 m12">
                                ...
                                <label for="value_new"> Boundary Wall Status</label>
    ...
    <script>
        $(document).ready(function () {
          ...
          /*   // adding table data into table start
            ...
            $('#rr_boundary_wall_table tbody').append(table_text);
            // adding table data into table ends */

            var table = $('#rr_boundary_wall_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
        ...
        function updateBoundaryWallStatus(){
          	 if(validator1.form()){ 
       			$(".page-loader").show();
       			$("#addUpdateModal").modal();
       			document.getElementById("updateBoundaryWallStatusForm").submit();	
           }
       }
         ...
         var validator1 = $('#updateBoundaryWallStatusForm').validate({
        	 rules: {
        		 	"value_new": {
    			 		  required: true
        			 }
        	...
        	swal({
    	            ...
    	            if (isConfirm) {
    	               // swal("Deleted!", "Record has been deleted", "success");
    	                $(".page-loader").show();
    	            	$('#getForm').attr('action', '<%=request.getContextPath()%>/delete-rr-boundary-wall-status');
    	    	    	$('#getForm').submit();
    	           }else {
