...
public class CommonConstants {
	...
	/*public final static String ACTIVITY_IMAGES = "Testing/pmis/Input_form_uploads/";
	public final static String P6_DATA_FILES = "Testing/pmis/P6_Data_Files/";
	public final static String LOGIN_BACKGROUND_IMAGE = "Testing/pmis";
	public static String LOGIN_BACKGROUND_IMAGE_URL = "https://syntrack-dev.s3.ap-south-1.amazonaws.com/Testing/pmis/login-background.jpg";*/
	
	/* Development S3 bucket path*/
	/*public final static String ACTIVITY_IMAGES = "Development/pmis/Input_form_uploads/";
	public final static String P6_DATA_FILES = "Development/pmis/P6_Data_Files/";
	public final static String LOGIN_BACKGROUND_IMAGE = "Development/pmis";	
	public static String LOGIN_BACKGROUND_IMAGE_URL = "https://syntrack-dev.s3.ap-south-1.amazonaws.com/Development/pmis/login-background.jpg";*/
	
	
	/*********** LOCAL ****************************************************/
	
	public final static String ACTIVITY_IMAGES = "E:"+File.separator+"Development"+File.separator+"nginx-1.9.9"+File.separator+"html"+File.separator+"pmis"+File.separator+"activity_images"+File.separator;
	public final static String P6_DATA_FILES = "E:"+File.separator+"Development"+File.separator+"nginx-1.9.9"+File.separator+"html"+File.separator+"pmis"+File.separator+"P6_Data_Files"+File.separator;
	...
	public final static String RISK_ANALYSIS_REPORTS_SAVING_PATH = "E:"+File.separator+"Development"+File.separator+"nginx-1.9.9"+File.separator+"html"+File.separator+"pmis"+File.separator+"RISK_ANALYSIS_REPORTS"+File.separator;
	...
	public final static String P6_DATA_FILES = "D:"+File.separator+"TestingServer"+File.separator+"nginx-1.9.9"+File.separator+"html"+File.separator+"pmis"+File.separator+"P6_Data_Files"+File.separator;
	public final static String LOGIN_BACKGROUND_IMAGE = "D:"+File.separator+"TestingServer"+File.separator+"nginx-1.9.9"+File.separator+"html"+File.separator+"pmis"+File.separator+"resources"+File.separator+"images"+File.separator;
	public static String LOGIN_BACKGROUND_IMAGE_URL = "/pmis/resources/images/login-background.jpg";
	public final static String CONTEXT_PATH = "http://183.82.105.133/pmis";
