                            ...
                            <div class="col s12 m4 l-align">
                               <!--  <div class="m-1 ">
                                   <a href="javascript:void(0);" onclick="openUploadDesignsModal();" class="btn waves-effect waves-light bg-s t-c">
                                    ...
                                    <p style="padding-top:1rem"> Click <a href="/wrpmis/Designs_Drawings.xlsx" download>here</a> for the template</p>
                                </div> -->
                            </div>
                        ...
                        <div class="row">
                            <div class="col m12 s12">
                                <table id="datatable-design" class="mdl-data-table">
                                    <thead>
                                        <tr>
                                            <th class="fw-40p">Contract </th>
                                            <th class="fw-40p">Title</th>
                                           <!--  <th>Structure </th>
                                            <th>Drawing Type </th>
