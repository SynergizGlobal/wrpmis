...
public class TypeOfFamilyDaoImpl implements TypeOfFamilyDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='rr_type_of_family' and s.name='dbo'\r\n" + 
	...
	public boolean updateTypeOfFamily(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table rr_type_of_family NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table rr_type_of_family CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
