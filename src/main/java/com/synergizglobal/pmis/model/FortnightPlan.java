...
public class FortnightPlan {
	...
	target_till_lfn,actual_till_lfn,target_this_fn,actual_this_fn,cum_target,cum_actual,filename,uploaded_by,uploaded_date,backlog_from_previous_months, upload_timestamp;
	...
	public String getBacklog_from_previous_months() {
		return backlog_from_previous_months;
	}

	public void setBacklog_from_previous_months(String backlog_from_previous_months) {
	...
	public void setUpload_timestamp(String upload_timestamp) {
