...
import com.synergizglobal.wrpmis.Idao.StructureGalleryPageDao;
...
public class StructureGalleryPageDaoImpl implements StructureGalleryPageDao{
	...
	public List<Structure> getGalleryList(Structure obj) throws Exception {
		...
		try {
			...
			String qry ="select id, structure_id_fk, name, sd.attachment,w.work_short_name,w.work_name, structure_file_type_fk, FORMAT(sd.created_date,'dd-MM-yyyy') AS created_date " 
