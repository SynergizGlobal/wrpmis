					...
					<%-- 		<c:if test="${action eq 'edit'}">
                            ...
                            <div class="col s6 m4 l4 input-field">
                                ...
                                <div class="col s6 m8 l4 input-field offset-m2">
                                    <input id="la_lattitude" maxlength="15" data-length="15" name="la_lattitude" type="number" class="validate w85 pdr4em num" value="">
	  						...
	  						<div class="row">                                 
                                ...
                                <div class="col s6 m8 l4 input-field offset-m2">
                                    <input id="la_longitude" maxlength="15" data-length="15" name="la_longitude" type="number" class="validate w85 pdr4em num" value="">
