    ...
    <div id="addUpdateModal" class="modal">
                        ...
                        <div class="row">
                            <div class="col s12 m6">
                               <div class="center-align m-1">
										<button type="button" onclick="addWebDocumentsType();" style="width: 100%;" class="btn waves-effect waves-light bg-m">Add</button>
								</div>
                            </div>
                            <div class="col s12 m6">
                                <div class="center-align m-1">
     ...
     <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-web-documents-type" id=updateWebDocumentsTypeForm name="updateWebDocumentsTypeForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header bg-m">Update Web Documents Type <span class="right modal-action modal-close"><span
                            class="material-icons">close</span></span></h5>
                <div class="row">
                    <div class="col m2 hide-on-small"></div>
                    <div class="col m8 s12">
                       <div class="row no-mar">
                        ...
                        <div class="row">
                            <div class="col s12 m6">
                                <div class="center-align m-1">
                                    <button style="width: 100%;" onclick="updateWebDocumentsType()"
...
<%--   <jsp:include page="../layout/footer.jsp"></jsp:include> --%>
    ...
    <script>
        ...
        function updateWebDocumentsType(){
        	 if(validator1.form()){ 
     			$(".page-loader").show();
