                                ...
                                <div class="col m1 hide-on-small-only"></div> -->
                                 <div class="col s6 m2 input-field">
                                    ...
                                    <p class="searchable_label">HOD</p>
                                        <select id="designation" name="designation" onchange="getContractList();" class="searchable">
                                            <option value="">Select</option>
                                    ...
                                    <p class="searchable_label">Dy HOD</p>
                                        <select id="dy_hod_designation" name="dy_hod_designation" onchange="getContractList();" class="searchable">
                                            <option value="">Select</option>
		...
		$.ajax({url : "<%=request.getContextPath()%>/mobileappwebview/ajax/getContracts",type:"POST",data:myParams,success : function(data){    				
				if(data != null && data != '' && data.length > 0){    					
	         		$.each(data,function(key,val){
	                    ...
	                    var actions = '<a href="javascript:void(0);"  onclick="getContract('+contract_id+');" class="btn mobile-btn waves-effect waves-light bg-m t-c" title="Edit"><i class="fa fa-pencil"></i></a>';    	                   	
	                   	var rowArray = [];    	                 
