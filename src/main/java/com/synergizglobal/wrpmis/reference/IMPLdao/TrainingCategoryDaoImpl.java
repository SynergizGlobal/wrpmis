...
import com.synergizglobal.wrpmis.reference.Idao.TrainingCategoryDao;
...
public class TrainingCategoryDaoImpl implements TrainingCategoryDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='training_category' and s.name='dbo'\r\n" + 
	...
	public boolean updateTrainingCategories(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table training_category NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table training_category CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
