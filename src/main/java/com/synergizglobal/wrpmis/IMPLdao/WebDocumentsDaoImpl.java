...
import com.synergizglobal.wrpmis.Idao.WebDocumentsDao;
...
public class WebDocumentsDaoImpl implements WebDocumentsDao{
	...
	public List<WebDocuments> getWebDocuments(WebDocuments obj) throws Exception {
		...
		try {
			...
			String docsQry ="select wd.id as web_document_id,title,file_name,category_id_fk,FORMAT(date_of_issue,'dd-MM-yyyy') as date_of_issue,FORMAT(date_of_issue,'dd-MMM-yy') as date_of_issue_ddmmmyy,FORMAT(upload_date,'dd-MMM-yy') as upload_date,uploaded_by,"
