...
public class SafetyCategoryDaoImpl implements SafetyCategoryDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='safety_category' and s.name='dbo'\r\n" + 
	...
	public boolean updateSafetyCategory(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table safety_category NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table safety_category CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
