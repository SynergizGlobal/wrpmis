...
import com.synergizglobal.wrpmis.reference.Idao.RiskPriorityDao;
import com.synergizglobal.wrpmis.reference.model.Safety;
import com.synergizglobal.wrpmis.reference.model.TrainingType;

@Repository
public class RiskPriorityDaoImpl  implements RiskPriorityDao{
	...
	public List<Safety> getRiskPriorityList() throws Exception {
		...
		try {
			String qry ="select risk_priority from risk_priority order by CONCAT( REPEAT(  '0', 8 - LEN( risk_priority ) ) , risk_priority ) asc";
	...
	public boolean addRiskPriority(Safety obj) throws Exception {
		...
		try {
			...
			String insertQry = "INSERT INTO risk_priority"
					+ "( risk_priority) VALUES (:risk_priority)";
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='risk_priority' and s.name='dbo'\r\n" + 
	...
	public boolean updateRiskPriority(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table risk_priority NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table risk_priority CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
