...
public class WebDocumentsTypeDaoImpl implements WebDocumentsTypeDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='web_documents_type' and s.name='dbo'\r\n" + 
	...
	public boolean updateWebDocumentsType(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table web_documents_type NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table web_documents_type CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
