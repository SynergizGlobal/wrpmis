...
import com.synergizglobal.wrpmis.reference.Idao.RiskAreaDao;
...
public class RiskAreaDaoImpl implements RiskAreaDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='risk_area' and s.name='dbo'\r\n" + 
	...
	public boolean updateRiskArea(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table risk_area NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table risk_area CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
