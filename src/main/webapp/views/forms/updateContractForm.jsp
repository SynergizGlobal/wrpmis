                           ...
                           <div class="row">
							...
							<div class="row" id="contract_type_fk_div">
	                            ...
	                            <div class="row" id="contract_status_fk_div">
	                                ...
	                                <div class="row">
		                            	<div class="col s6 m6 l4 input-field" id="planned_date_of_award_div">
		                                ...
		                                <div class="col s12 m6 l4 input-field" id="contract_notice_inviting_tender_div">
		                                    <input id="contract_notice_inviting_tender" name="contract_notice_inviting_tender" type="text" class="validate datepicker" value="${contractDeatils.contract_notice_inviting_tender }">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col s12 m4 l4 input-field">
	                                    <input autocomplete="off" id="pbg_release" name="pbg_release" type="text" class="validate datepicker-max-today" value="${contractDeatils.pbg_release }">
                                        ...
                                        <c:when test="${not empty contractDeatils.bankGauranree && fn:length(contractDeatils.bankGauranree) gt 0 }">
                                		  <c:forEach var="bankObj" items="${contractDeatils.bankGauranree }" varStatus="index">   
                                            <tr id="bankRow${index.count }" class="bg-rows <c:if test='${not empty bankObj.release_date}'>bg-released</c:if>">
                                                ...
                                                <td data-head="Amount" class="input-field amount-dropdown">
                                                		<i class="material-icons amount-symbol cost left-align">₹</i>
					                                	...
					                                	<span id="bg_units${index.count }Error" class="my-error right"></span>
                                                 </td>
                                               ...
                                               <!--  <td>
                                                ...
                                                <td data-head="Amount " class="input-field">      
                                               		<span class="amount-dropdown">
					                                	...
					                                	<span id="bg_units0Error" class="my-error right"></span>
                                               		</span>  
                                                  </td>
                                                  <%-- <td class="responsive_units">
                                          ...
                                          <c:forEach var="insurenceObj" items="${contractDeatils.insurence }" varStatus="index">  
                                            <tr id="insurenceRow${index.count }" class="insurance-rows <c:if test='${insurenceObj.insurance_status eq "Yes"}'>insurance-released</c:if>">
                                                ...
                                                <td data-head="Insurance Value" class="input-field amount-dropdown">
					                                	...
					                                	<span id="insurence_units${index.count }Error" class="my-error my-error"></span>
                                                    </td> 
                                                    <%-- <td class="responsive_units">
                                             ...
                                             <c:otherwise>
                                              ...
                                              <tr id="insurenceRow0">
                                                ...
                                                <td data-head="Insurance Value " class="input-field amount-dropdown">
					                                	...
					                                	<span id="insurence_units0Error" class="my-error right"></span>
                                                    </td> 
                                                   <%--  <td class="responsive_units">
	...
	<input type="checkbox" id="approval_by_bank${index.count }"  class="revision_amount_status"  name="approval_by_bank" value="No" onChange="getApprovalByBankRevisions('${index.count }');" 
                                             ...
                                             <tr id="revRow0">
                                                ...
                                                <td data-head="Revised Amount " class="input-field amount-dropdown">
					                                	...
					                                	<span id="units0Error" class="my-error right"></span>
                                                </td>
                                             <%--    <td class="responsive_units  "> 
    ...
    $(document).ready(function() {
	 ...
	 $("[data-length]").each(function(i,val){
        ...
        function updateContract(){
        	...
        	$('form select[name=department_fks]').each(function(){
       ...
       /*  
        ...
        function addBankRow(){
				  ...
				  // +'<td><input id="bank_addresss'+rNo+'" name ="bank_addresss" type="text" class="validate"  placeholder="Bank Address"></td>'
				   ...
				   +'</select><span id="bg_units'+rNo+'Error" class="my-error right"></span> </td>'
		...
		function addInsurenceRow(){
		    ...
		    var html = '<tr id="insurenceRow'+rNo+'"><td data-head="Insurance Type " class="input-field min-w-120">'
			  ...
			  // +'<td class="input-field"><i class="material-icons prefix cost left-align">₹</i><input id="insurance_values'+rNo+'" name="insurance_values" type="number" min="0.01" step="0.01" class="validate" placeholder="Insurance Value"></td>'
			   ...
			   +'</select> <span id="insurence_units'+rNo+'Error" class="my-error right"></span></td>' 
 ...
 */			   
		...
		function getapprovalByBankFileName(rowNo)
		{
			var filename = $('#approvalByBankFiles'+rowNo)[0].files[0].name;
		    $('#approvalByBankDocumentFileName'+rowNo).html(filename);
