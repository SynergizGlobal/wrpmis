	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:if test="${obj.surveyStatusId eq '1' }">
	                                            		<a class="fa fa-star tooltip"  onclick="updateLAStatus('${obj.landAcquisitionId}','Not Started')">
		                                                    <span class="tooltiptext">Survey Status</span>
		                                                </a>
	                                            	</c:if>
	                                            	<c:if test="${obj.surveyStatusId eq '2' }">
	                                            		<a class="fa fa-star half tooltip"  onclick="updateLAStatus('${obj.landAcquisitionId}','Survey')">
		                                                    <span class="tooltiptext">Survey Status</span>
		                                                </a>
	                                            	</c:if>
	                                            	<c:if test="${obj.surveyStatusId eq '3' }">
	                                            		<a class="fa fa-star full tooltip">
		                                                    <span class="tooltiptext">Survey Status</span>
		                                                </a>
	                                            	</c:if>
	                                            	
	                                            	<c:if test="${obj.valuationStatusId eq '1' }">
	                                            		<a class="fa fa-star tooltip">
		                                                    <span class="tooltiptext">Valuation Status</span>
		                                                </a>
	                                            	</c:if>
	                                            	<c:if test="${obj.valuationStatusId eq '2' }">
	                                            		<a class="fa fa-star half tooltip"  onclick="updateLAStatus('${obj.landAcquisitionId}','Valuation')">
		                                                    <span class="tooltiptext">Valuation Status</span>
		                                                </a>
	                                            	</c:if>
	                                            	...
	                                            	<c:if test="${obj.approvalStatusId eq '1' }">
	                                            		<a class="fa fa-star tooltip">
		                                                    <span class="tooltiptext">Approval Status</span>
		                                                </a>
	                                            	</c:if>
	                                            	<c:if test="${obj.approvalStatusId eq '2' }">
	                                            		<a class="fa fa-star half tooltip"  onclick="updateLAStatus('${obj.landAcquisitionId}','Approval')">
		                                                    <span class="tooltiptext">Approval Status</span>
		                                                </a>
	                                            	</c:if>
	                                            	...
	                                            	<c:if test="${obj.paymentStatusId eq '1' }">
	                                            		<a class="fa fa-star tooltip">
		                                                    <span class="tooltiptext">Payment Status</span>
		                                                </a>
	                                            	</c:if>
	                                            	<c:if test="${obj.paymentStatusId eq '2' }">
	                                            		<a class="fa fa-star half tooltip"  onclick="updateLAStatus('${obj.landAcquisitionId}','Payment')">
		                                                    <span class="tooltiptext">Payment Status</span>
		                                                </a>
	                                            	</c:if>
	                                            	...
	                                            	<c:if test="${obj.acquisitionStatusId eq '1' }">
	                                            		<a class="fa fa-star tooltip">
		                                                    <span class="tooltiptext">Acquisition Status</span>
		                                                </a>
	                                            	</c:if>
	                                            	<c:if test="${obj.acquisitionStatusId eq '2' }">
	                                            		<a class="fa fa-star half tooltip"  onclick="updateLAStatus('${obj.landAcquisitionId}','Acquisition')">
		                                                    <span class="tooltiptext">Acquisition Status</span>
		                                                </a>
	                                            	</c:if>
	                                            ...
	                                            <%-- <td>${obj.activeStatus }
	                                            	<c:if test="${obj.activeStatus ne 'Completed' }">
	                                            	 <a onclick="updateLAStatus('${obj.landAcquisitionId}','${obj.activeStatus}')" class="waves-effect waves-light modal-trigger">
...
<!-- card ending -->
    ...
    <div id="StatusUpdateModal" class="modal">
        <div class="modal-content">
            ...
            <!-- form start-->
            <div class="container">
                <form action="<%=request.getContextPath() %>/update-land-acquisition-status-3" id="updateForm" name="updateForm" method="post">
  ...
  <form action="<%=request.getContextPath()%>/get-land-acquisition-3" id="getForm" name="getForm" method="post">
