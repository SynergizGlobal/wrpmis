...
public class WebDocumentCategoryDaoImpl implements WebDocumentCategoryDao{
	...
	public TrainingType getWebDocumentsCategoryDetails(TrainingType obj) throws Exception {
		...
		try {
			String qry ="select id, type_fk, category from web_documents_category ";
	...
	public boolean updateWebDocumentsCategory(TrainingType obj) throws Exception {
		...
		try {
			...
			String  updatereferenceTableQry = "UPDATE web_documents_category SET `category`= :value_new, type_fk = :type_fk_new  WHERE `category`= :value_old " ;
			paramSource = new BeanPropertySqlParameterSource(obj);		 
			count = namedParamJdbcTemplate.update(updatereferenceTableQry, paramSource);	
			
			for (TrainingType bObj : obj.getdList()) {
				
				String updateTableQry = "UPDATE "+bObj.getTable_name()+" SET "+bObj.getColumn_name()+" =:value_new WHERE "+bObj.getColumn_name()+"= :id " ;
	...
	public boolean deleteWebDocumentsCategory(TrainingType obj) throws Exception {
		...
		try {
			...
			String deleteQry ="DELETE from web_documents_category WHERE `id`= :id; ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
