...
<head>
    ...
    <title>
     	 <c:if test="${action eq 'edit'}">Update Reports</c:if>
		 <c:if test="${action eq 'add'}"> Add Reports</c:if>
    </title>
...
<body>
                            ...
                            <div class="row" style="margin-bottom: 20px;">
                                ...
                                <div class="col s12 m8">
                                    <div class="row fixed-width">
                                        <h5 class="center-align">Reports Details</h5>
                                        <div class="table-inside">
                                            <table id="reports_form_table" class="mdl-data-table">
                                                <thead>
                                                    <tr>
                                                        <th>Access Type </th>
                                                        <th>Access Value </th>
    ...
    <script>
        ...
        function addRow() {
            ...
            $('#reports_form_table').find('tr:last').prev().after(text);
            $('.searchable').select2();
            No++;
        }
    </script>
