...
public class ActivitiesProgressReport {
	...
	department_fk,structure_type,component_id,updated,approved,rejected,hod_designation,remarks,dyhod_designation,work_status_fk;
	...
	List<ActivitiesProgressReport> progressUpdateList;
	
	
	public List<ActivitiesProgressReport> getProgressUpdateList() {
		return progressUpdateList;
	}

	public void setProgressUpdateList(List<ActivitiesProgressReport> progressUpdateList) {
		this.progressUpdateList = progressUpdateList;
	}
	...
	public String getComponent_id_name() {
		return component_id_name;
	}

	public void setComponent_id_name(String component_id_name) {
		this.component_id_name = component_id_name;
	}
	...
	public String getExcluded_scope() {
