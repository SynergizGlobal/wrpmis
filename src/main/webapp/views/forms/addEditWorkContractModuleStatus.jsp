			              ...
			              <c:if test="${action eq 'add'}">				                
                            ...
                            <div id="header">
                       		 ...
                       		 <div class="row">
                       		  <div class="col s12 m4 input-field">
								 <p class="searchable_label">Project</p>
                                         	 	<input type="text" value="${workStatusDetails.project_id_fk} - ${workStatusDetails.project_name}" readonly />
								 </div> 
								  <div class="col s12 m4 input-field"> 
								   <p class="searchable_label">Work</p>
                                         	 	<input type="text" value="${workStatusDetails.work_id_fk} - ${workStatusDetails.work_name}" readonly />
                                  </div>
                                  </div>
                                   <div class="row">
                                    <div class="col s12 m4 input-field"> 
                     				 <p class="searchable_label">Contract</p>
                              				   <input type="text" value="${workStatusDetails.contract_id_fk} - ${workStatusDetails.contract_name}" readonly />
	                              </div><br>
	                              <div class="col s12 m4 input-field">
	                                    <input id="date" type="text" class="validate datepicker" name="month" value="${workStatusDetails.month }"> 
	                                    <label for="date"> Date </label>
      ...
      //geting works list from database    
        function getWorksList(projectId) {
            ...
            if ($.trim(projectId) != "") {
                ...
                $.ajax({
                    url: "<%=request.getContextPath()%>/ajax/getWorkListForWorkContractModuleStatusForm",
        ...
        function getContractsList(work_id_fk) {
            ...
            if ($.trim(work_id_fk) != "") {
                ...
                $.ajax({
                	url: "<%=request.getContextPath()%>/ajax/getContractsListForWorkContractModuleStatusForm",
                    data: myParams, cache: false,
                    success: function (data) {
                        if (data.length > 0) {
                            $.each(data, function (i, val) {
