                                            ...
                                            <table id="app_com_tableRevision" class="mdl-data-table" style="width:100%;">
                                                ...
                                                <input type="hidden" id="sNoRevision" value="1">
                                                       <tr>
                                                        	...
                                                        	<textarea name="tender_bid_remarks" maxlength="1000" data-length="1000" id="tender_bid_remarks0" class="validate pmis-textarea w90 pdr4em" style="height: 59px;"></textarea>
