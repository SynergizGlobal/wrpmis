                    ...
                    <div class="container container-no-margin">
                        <form action="#">
                            ...
                            <div class="row">
                                ...
                                <div class="col m2 hide-on-small-only"></div>
                                <div class="col s12 m4 input-field">
                                    <input id="phase" type="text" class="validate">
                            ...
                            <div class="row">
                                ...
                                <div class="col m2 hide-on-small-only"></div>
                                <div class="col s12 m4 input-field">
                                    <input id="affected_structure" type="text" class="validate">
                                    <label for="affected_structure">Affected Structure</label>
                                </div>
                                <div class="col s12 m4 input-field">
                                    <input id="affected_people" type="text" class="validate">
                                    <label for="affected_people">Affected People</label>
                                </div>
                                <div class="col m2 hide-on-small-only"></div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col s12 m4 input-field">
                                    ...
                                    <label>Resettlement Status</label>
                                </div>
                                <div class="col m2 hide-on-small-only"></div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col s12 m4">
                                    <div class="center-align m-1">
                                        <button type="submit"  class="btn waves-effect waves-light bg-m" width="100%"> Create / Update </button>
                                    </div>
                                </div>
                                <div class="col s12 m4">
                                    <div class="center-align m-1">
                                        <button type="button" class="btn waves-effect waves-light bg-s" width="inherit">Cancel</button>
                                    </div>
                                </div>
                                <div class="col m2 hide-on-small-only"></div>
                            </div>
