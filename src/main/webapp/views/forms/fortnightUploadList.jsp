                ...
                <div class="card ">
                    <div class="card-content ">
						<div class="m-n1" style="text-align:right;">
					        <a href="/wrpmis/fortnight-upload-remarks" class="btn waves-effect waves-light bg-s t-c"> <strong>Upload</strong></a>
					    </div>                  
	                                ...
	                                <table id="datatable-p6-new-data" class="mdl-data-table">
	                                    ...
	                                    <tbody>
                                            <c:forEach var="obj" items="${FortnightUploadList}">
                                            	...
                                            	<td><a href="/wrpmis/FORTNIGHT_PLAN_UPLOAD_REMARKS_PATH/${obj.filename }" class="btn waves-effect waves-light bg-m t-c mob-btn"><i class="fa fa-download"></i></a></td>
                                            	</tr>
                                             </c:forEach>	                                    
	                                    </tbody>
	                                </table>
