...
import com.synergizglobal.wrpmis.Idao.ActivitiesUploadDao;
...
public class ActivitiesUploadDaoImpl implements ActivitiesUploadDao{
	...
	public List<Activity> getFOBContractsList(Activity obj) throws Exception {
		...
		try {
			...
			String qry ="select fob_id_fk as fob_id  from fob_contract_responsible_people where contract_id_fk = ? group by fob_id_fk";
