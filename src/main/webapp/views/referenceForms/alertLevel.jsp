...
<body>
                        ...
                        <div class="row no-mar">
                            <div class="col s12 center-align">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Alert Level</a>
                            </div>
                        </div>
                        <div class="row no-mar">
    ...
    <div id="addUpdateModal" class="modal">
		<form action="<%=request.getContextPath() %>/add-alert-level" id="alertLevelForm" name="alertLevelForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header">Add Alert Level <span class="right modal-action modal-close" onclick="removeErrorMsg()"><span
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="alert_level_text" name="alert_level" type="text" class="validate" onkeyup="doValidate(this.value)" >
                                <label for="alert_level_text">Alert Level</label>
     ...
     <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-alert-level" id=updateAlertLevelForm name="updateAlertLevelForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header bg-m">Update Alert Level <span class="right modal-action modal-close"><span
                            class="material-icons">close</span></span></h5>
                <div class="row">
                    <div class="col m2 hide-on-small"></div>
                    <div class="col m8 s12">
                       <div class="row no-mar">
                         <div class="input-field col s12 m12">
                                ...
                                <label for="value_new">Alert Level</label>
...
<%--   <jsp:include page="../layout/footer.jsp"></jsp:include> --%>
	<form name="getForm" id="getForm" method="post">
    	<input type="hidden" name="alert_level" id="alert_level" />
    </form>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#alert_level_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
        ...
        function doValidate(value){
           var print_value = value;
     	   ...
     	   while(count < validate){
     		   ...
     		   if(findVal == value){
     			   $('#alert_levelError').text(print_value+' alreday exists').css('color', 'red');
     			   $('#bttn').prop('disabled', true);
     			   flag = false;
     			   return false;
     		   }else{
     			   $('#alert_levelError').text('');
        ...
        $("#alertLevelForm").submit(function (e) {
           	 if(validator.form()){ 
       			$(".page-loader").show();
        ...
        var validator =	$('#alertLevelForm').validate({
       	 rules: {
        	 ...
        	 if(element.attr("id") == "alert_level_text" ){
      ...
      var validator1 = $('#updateAlertLevelForm').validate({
        ...
        function updateRow(no) {
            var alert_level = $('#alert_levelId'+no).val();
            $('#value_old').val($.trim(alert_level))
            $('#onlyUpdateModal').modal('open');
            $('#onlyUpdateModal #value_new').val($.trim(alert_level)).focus();
        }
