...
import com.synergizglobal.wrpmis.Iservice.DashboardsAccessService;
...
public class DashboardsAccessController {
	...
	@RequestMapping(value="/add-new-dashboard",method={RequestMethod.GET})
	public ModelAndView addNewDashboard(@ModelAttribute Dashboard obj,HttpSession session){
		ModelAndView model = new ModelAndView();
		try {
			model.setViewName(PageConstants2.NEW_DASHBOARD_ACCESS_FORM);
