...
public class LandAcquisitionDaoImpl implements LandAcquisitionDao{
	...
	public List<LandAcquisition> getLandAcquisitionList(LandAcquisition obj, int startIndex, int offset, String searchParameter) throws Exception {
		...
		try {
			String qry ="select distinct la_id,survey_number,li.remarks,li.area_to_be_acquired,li.category_fk as type_of_land,li.la_land_status_fk,li.work_id_fk,w.work_name,w.project_id_fk,p.project_name,ISNULL(li.category_fk,c.la_category) as type_of_land ,sc.la_sub_category as sub_category_of_land, w.work_short_name,village_id,la_sub_category_fk,village,cast(area_of_plot as CHAR) as area_of_plot,modified_by,FORMAT(modified_date,'%d-%m-%Y') as modified_date " + 
	...
	public LandAcquisition getLandAcquisitionForm(LandAcquisition obj) throws Exception {					
		...
		try {
			String qry = "select distinct la_id,li.remarks,(select executive_user_id_fk from land_executives re where li.work_id_fk = re.work_id_fk and executive_user_id_fk = ?) as executive_user_id_fk,cast(li.area_to_be_acquired as CHAR) as area_to_be_acquired,ISNULL(li.category_fk,c.la_category) as type_of_land,li.la_land_status_fk, work_id_fk,w.project_id_fk,p.project_name,w.work_short_name,sc.la_sub_category as sub_category_of_land, li.survey_number, li.village_id, li.village, taluka, dy_slr, sdo, li.collector, FORMAT(proposal_submission_date_to_collector,'%d-%m-%Y') AS proposal_submission_date_to_collector, cast(area_of_plot as CHAR) as area_of_plot, jm_fee_amount,jm_fee_amount_units, "
					+ "li.special_feature,cast(li.area_acquired as CHAR) as area_acquired,li.private_land_process,cast(chainage_from as CHAR) as chainage_from,cast(chainage_to as CHAR) as chainage_to, FORMAT(jm_fee_letter_received_date,'%d-%m-%Y') AS jm_fee_letter_received_date,FORMAT(jm_fee_paid_date,'%d-%m-%Y') AS jm_fee_paid_date,FORMAT(jm_start_date,'%d-%m-%Y') AS  jm_start_date,FORMAT(jm_completion_date,'%d-%m-%Y') AS jm_completion_date, FORMAT(jm_sheet_date_to_sdo,'%d-%m-%Y') AS jm_sheet_date_to_sdo, jm_remarks, jm_approval, li.issues"
					
					+ ",lg.id, lg.la_id_fk,FORMAT(lg.proposal_submission,'%d-%m-%Y') AS proposal_submission, lg.proposal_submission_status_fk, FORMAT(lg.valuation_date,'%d-%m-%Y') AS valuation_date, FORMAT(lg.letter_for_payment,'%d-%m-%Y') AS letter_for_payment,"
					+ "lg.amount_demanded,cast(lg.lfp_status_fk as CHAR) as lfp_status_fk,FORMAT(lg.approval_for_payment,'%d-%m-%Y') AS approval_for_payment,FORMAT(lg.payment_date,'%d-%m-%Y') AS payment_date, lg.amount_paid, lg.payment_status_fk, FORMAT(lg.possession_date,'%d-%m-%Y') AS possession_date,"
					...
					//lg.special_feature, 
					+ "lg.amount_demanded_units,lg.amount_paid_units, FORMAT(lf.on_line_submission,'%d-%m-%Y') AS forest_online_submission, FORMAT(lf.submission_date_to_dycfo,'%d-%m-%Y') AS forest_submission_date_to_dycfo, FORMAT(lf.submission_date_to_ccf_thane,'%d-%m-%Y') AS forest_submission_date_to_ccf_thane, "
					+ "FORMAT(lf.submission_date_to_nodal_officer,'%d-%m-%Y') AS forest_submission_date_to_nodal_officer, FORMAT(lf.submission_date_to_revenue_secretary_mantralaya,'%d-%m-%Y') AS forest_submission_date_to_revenue_secretary_mantralaya, FORMAT(lf.submission_date_to_regional_office_nagpur,'%d-%m-%Y') AS forest_submission_date_to_regional_office_nagpur,"
					+ " FORMAT(lf.date_of_approval_by_regional_office_nagpur,'%d-%m-%Y') AS forest_date_of_approval_by_regional_office_nagpur, FORMAT(lf.valuation_by_dycfo,'%d-%m-%Y') AS forest_valuation_by_dycfo,cast(lf.demanded_amount as CHAR) as forest_demanded_amount,cast(lf.payment_amount  as CHAR) as forest_payment_amount, FORMAT(lf.approval_for_payment,'%d-%m-%Y') AS forest_approval_for_payment"
					+ ", FORMAT(lf.payment_date,'%d-%m-%Y') AS forest_payment_date,FORMAT(lf.possession_date,'%d-%m-%Y') AS forest_possession_date,lf.possession_status_fk as forest_possession_status_fk,"
					...
					+ "lpa.forest_tree_rate,FORMAT(lpa.consent_from_owner,'%d-%m-%Y') AS consent_from_owner, FORMAT(lpa.legal_search_report,'%d-%m-%Y') AS legal_search_report, FORMAT(lpa.date_of_registration,'%d-%m-%Y') AS date_of_registration, FORMAT(lpa.date_of_possession,'%d-%m-%Y') AS date_of_possession, lpa.possession_status_fk as private_possession_status_fk, "
					...
					+ "lpv.payment_amount_units,FORMAT(lpv.forest_tree_survey ,'%d-%m-%Y') AS forest_tree_survey,FORMAT(lpv.forest_tree_valuation ,'%d-%m-%Y') AS forest_tree_valuation, lpv.forest_tree_valuation_status_fk,FORMAT(lpv.horticulture_tree_survey ,'%d-%m-%Y') AS horticulture_tree_survey,FORMAT(lpv.horticulture_tree_valuation ,'%d-%m-%Y') AS horticulture_tree_valuation, "
					+ "FORMAT(lpv.structure_survey ,'%d-%m-%Y') AS structure_survey,FORMAT(lpv.structure_valuation ,'%d-%m-%Y') AS structure_valuation,FORMAT(lpv.borewell_survey ,'%d-%m-%Y') AS borewell_survey,FORMAT(lpv.borewell_valuation ,'%d-%m-%Y') AS borewell_valuation, lpv.horticulture_tree_valuation_status_fk, lpv.structure_valuation_status_fk, "
					+ "lpv.borewell_valuation_status_fk, lpv.rfp_to_adtp_status_fk, FORMAT(lpv.date_of_rfp_to_adtp ,'%d-%m-%Y') AS date_of_rfp_to_adtp,FORMAT(lpv.date_of_rate_fixation_of_land ,'%d-%m-%Y') AS date_of_rate_fixation_of_land, FORMAT(lpv.sdo_demand_for_payment ,'%d-%m-%Y') AS sdo_demand_for_payment,FORMAT(lpv.date_of_approval_for_payment ,'%d-%m-%Y') AS date_of_approval_for_payment, "
					+ "cast(lpv.payment_amount as CHAR) as payment_amount, FORMAT(lpv.payment_date ,'%d-%m-%Y') AS private_payment_date  "
					
					+ " ,ira.collector as private_ira_collector, FORMAT(submission_of_proposal_to_GM ,'%d-%m-%Y') AS submission_of_proposal_to_GM,FORMAT(approval_of_GM ,'%d-%m-%Y') AS  approval_of_GM,FORMAT(draft_letter_to_con_for_approval_rp ,'%d-%m-%Y') AS draft_letter_to_con_for_approval_rp,FORMAT(date_of_approval_of_construction_rp ,'%d-%m-%Y') AS  date_of_approval_of_construction_rp,FORMAT(date_of_uploading_of_gazette_notification_rp ,'%d-%m-%Y') AS date_of_uploading_of_gazette_notification_rp,"
					+ "FORMAT(publication_in_gazette_rp ,'%d-%m-%Y') AS publication_in_gazette_rp,FORMAT(date_of_proposal_to_DC_for_nomination ,'%d-%m-%Y') AS  date_of_proposal_to_DC_for_nomination, FORMAT(date_of_nomination_of_competenta_authority ,'%d-%m-%Y') AS date_of_nomination_of_competenta_authority, FORMAT(draft_letter_to_con_for_approval_ca ,'%d-%m-%Y') AS draft_letter_to_con_for_approval_ca, FORMAT(date_of_approval_of_construction_ca ,'%d-%m-%Y') AS date_of_approval_of_construction_ca, "
					+ "FORMAT(date_of_uploading_of_gazette_notification_ca ,'%d-%m-%Y') AS date_of_uploading_of_gazette_notification_ca, FORMAT(publication_in_gazette_ca ,'%d-%m-%Y') AS publication_in_gazette_ca, FORMAT(date_of_submission_of_draft_notification_to_CALA ,'%d-%m-%Y') AS date_of_submission_of_draft_notification_to_CALA,FORMAT(approval_of_CALA_20a ,'%d-%m-%Y') AS approval_of_CALA_20a,FORMAT(draft_letter_to_con_for_approval_20a ,'%d-%m-%Y') AS draft_letter_to_con_for_approval_20a,"
					+ "FORMAT(date_of_approval_of_construction_20a ,'%d-%m-%Y') AS date_of_approval_of_construction_20a,FORMAT(date_of_uploading_of_gazette_notification_20a ,'%d-%m-%Y') AS date_of_uploading_of_gazette_notification_20a,FORMAT(publication_in_gazette_20a ,'%d-%m-%Y') AS publication_in_gazette_20a,FORMAT(publication_in_2_local_news_papers_20a ,'%d-%m-%Y') AS publication_in_2_local_news_papers_20a,FORMAT(pasting_of_notification_in_villages_20a ,'%d-%m-%Y') AS pasting_of_notification_in_villages_20a,"
					+ "FORMAT(receipt_of_grievances ,'%d-%m-%Y') AS  receipt_of_grievances, FORMAT(disposal_of_grievances ,'%d-%m-%Y') AS disposal_of_grievances, FORMAT(date_of_submission_of_draft_notification_to_CALA_20e ,'%d-%m-%Y') AS date_of_submission_of_draft_notification_to_CALA_20e, FORMAT(approval_of_CALA_20e ,'%d-%m-%Y') AS  approval_of_CALA_20e,FORMAT(draft_letter_to_con_for_approval_20e ,'%d-%m-%Y') AS  draft_letter_to_con_for_approval_20e,"  
					+"FORMAT(date_of_approval_of_construction_20e ,'%d-%m-%Y') AS  date_of_approval_of_construction_20e,FORMAT(date_of_uploading_of_gazette_notification_20e ,'%d-%m-%Y') AS date_of_uploading_of_gazette_notification_20e,FORMAT(publication_in_gazette_20e ,'%d-%m-%Y') AS  publication_in_gazette_20e,FORMAT(publication_of_notice_in_2_local_news_papers_20e ,'%d-%m-%Y') AS publication_of_notice_in_2_local_news_papers_20e,FORMAT(date_of_submission_of_draft_notification_to_CALA_20f ,'%d-%m-%Y') AS date_of_submission_of_draft_notification_to_CALA_20f," 
					+"FORMAT(approval_of_CALA_20f ,'%d-%m-%Y') AS approval_of_CALA_20f,FORMAT(draft_letter_to_con_for_approval_20f ,'%d-%m-%Y') AS draft_letter_to_con_for_approval_20f,FORMAT(date_of_approval_of_construction_20f ,'%d-%m-%Y') AS date_of_approval_of_construction_20f,FORMAT(date_of_uploading_of_gazette_notification_20f ,'%d-%m-%Y') AS date_of_uploading_of_gazette_notification_20f,FORMAT(publication_in_gazette_20f ,'%d-%m-%Y') AS publication_in_gazette_20f,"
					+ "FORMAT(publication_of_notice_in_2_local_news_papers_20f ,'%d-%m-%Y') AS publication_of_notice_in_2_local_news_papers_20f,FORMAT(lg.planned_date_of_possession ,'%d-%m-%Y') as planned_date_of_possession,latitude,longitude "
					+"from la_land_identification li "
				...
				if(!StringUtils.isEmpty(obj.getJm_approval())) {
					if(obj.getCategory_fk().equalsIgnoreCase("Government")) {
						...
						//{	
							...
							String qry = "select distinct la_id,li.remarks,cast(li.area_to_be_acquired as CHAR) as area_to_be_acquired,ISNULL(li.category_fk,c.la_category) as type_of_land,li.la_land_status_fk, work_id_fk,w.project_id_fk,p.project_name,w.work_short_name,sc.la_sub_category as sub_category_of_land, li.survey_number, li.village_id, li.village, taluka, dy_slr, sdo, li.collector, FORMAT(proposal_submission_date_to_collector,'%d-%m-%Y') AS proposal_submission_date_to_collector, cast(area_of_plot as CHAR) as area_of_plot, jm_fee_amount,jm_fee_amount_units, "
									+ "li.special_feature,cast(li.area_acquired as CHAR) as area_acquired,li.private_land_process,cast(chainage_from as CHAR) as chainage_from,cast(chainage_to as CHAR) as chainage_to, FORMAT(jm_fee_letter_received_date,'%d-%m-%Y') AS jm_fee_letter_received_date,FORMAT(jm_fee_paid_date,'%d-%m-%Y') AS jm_fee_paid_date,FORMAT(jm_start_date,'%d-%m-%Y') AS  jm_start_date,FORMAT(jm_completion_date,'%d-%m-%Y') AS jm_completion_date, FORMAT(jm_sheet_date_to_sdo,'%d-%m-%Y') AS jm_sheet_date_to_sdo, jm_remarks, jm_approval, li.issues"
									...
									+"FORMAT(date_of_approval_of_construction_20e ,'%d-%m-%Y') AS  date_of_approval_of_construction_20e,FORMAT(date_of_uploading_of_gazette_notification_20e ,'%d-%m-%Y') AS date_of_uploading_of_gazette_notification_20e,FORMAT(publication_in_gazette_20e ,'%d-%m-%Y') AS  publication_in_gazette_20e,FORMAT(publication_of_notice_in_2_local_news_papers_20e ,'%d-%m-%Y') AS publication_of_notice_in_2_local_news_papers_20e,FORMAT(date_of_submission_of_draft_notification_to_CALA_20f ,'%d-%m-%Y') AS date_of_submission_of_draft_notification_to_CALA_20f," 
									+"FORMAT(approval_of_CALA_20f ,'%d-%m-%Y') AS approval_of_CALA_20f,FORMAT(draft_letter_to_con_for_approval_20f ,'%d-%m-%Y') AS draft_letter_to_con_for_approval_20f,FORMAT(date_of_approval_of_construction_20f ,'%d-%m-%Y') AS date_of_approval_of_construction_20f,FORMAT(date_of_uploading_of_gazette_notification_20f ,'%d-%m-%Y') AS date_of_uploading_of_gazette_notification_20f,FORMAT(publication_in_gazette_20f ,'%d-%m-%Y') AS publication_in_gazette_20f,"
									+ "FORMAT(publication_of_notice_in_2_local_news_papers_20f ,'%d-%m-%Y') AS publication_of_notice_in_2_local_news_papers_20f, FORMAT(lg.planned_date_of_possession ,'%d-%m-%Y') as planned_date_of_possession "
									+"from la_land_identification li "
									+"left join la_government_land_acquisition lg on li.la_id = lg.la_id_fk " 
									+"left join la_forest_land_acquisition lf on li.la_id = lf.la_id_fk " 
									+"left join la_railway_land_acquisition lr on li.la_id = lr.la_id_fk " 
	...
	public List<LandAcquisition> getLandAcquisitionList(LandAcquisition obj) throws Exception {
		List<LandAcquisition> objsList = null;
		try {
			String qry ="select distinct la_id,li.remarks,cast(li.area_to_be_acquired as CHAR) as area_to_be_acquired,ISNULL(li.category_fk,c.la_category) as type_of_land,li.la_land_status_fk, li.work_id_fk,w.project_id_fk,p.project_name,w.work_short_name,sc.la_sub_category as sub_category_of_land, li.survey_number, li.village_id, li.village, taluka, dy_slr, sdo, li.collector, FORMAT(proposal_submission_date_to_collector,'%d-%m-%Y') AS proposal_submission_date_to_collector, cast(area_of_plot as CHAR) as area_of_plot, jm_fee_amount,jm_fee_amount_units, " + 
					"li.special_feature,cast(li.area_acquired as CHAR) as area_acquired,li.private_land_process,cast(chainage_from as CHAR) as chainage_from,cast(chainage_to as CHAR) as chainage_to, FORMAT(jm_fee_letter_received_date,'%d-%m-%Y') AS jm_fee_letter_received_date,FORMAT(jm_fee_paid_date,'%d-%m-%Y') AS jm_fee_paid_date,FORMAT(jm_start_date,'%d-%m-%Y') AS  jm_start_date,FORMAT(jm_completion_date,'%d-%m-%Y') AS jm_completion_date, FORMAT(jm_sheet_date_to_sdo,'%d-%m-%Y') AS jm_sheet_date_to_sdo, jm_remarks, jm_approval, li.issues " + 
					" from la_land_identification li " +
					"left join land_executives le on li.work_id_fk = le.work_id_fk  "+
					"left join work w on li.work_id_fk = w.work_id "+
	...
	public List<LandAcquisition> geprivateIRAList(String la_id) throws Exception {
		...
		try {
			String qry = "select la_id_fk,ira.collector as private_ira_collector, FORMAT(submission_of_proposal_to_GM ,'%d-%m-%Y') AS submission_of_proposal_to_GM,FORMAT(approval_of_GM ,'%d-%m-%Y') AS  approval_of_GM,FORMAT(draft_letter_to_con_for_approval_rp ,'%d-%m-%Y') AS draft_letter_to_con_for_approval_rp,FORMAT(date_of_approval_of_construction_rp ,'%d-%m-%Y') AS  date_of_approval_of_construction_rp,FORMAT(date_of_uploading_of_gazette_notification_rp ,'%d-%m-%Y') AS date_of_uploading_of_gazette_notification_rp," + 
					"FORMAT(publication_in_gazette_rp ,'%d-%m-%Y') AS publication_in_gazette_rp,FORMAT(date_of_proposal_to_DC_for_nomination ,'%d-%m-%Y') AS  date_of_proposal_to_DC_for_nomination, FORMAT(date_of_nomination_of_competenta_authority ,'%d-%m-%Y') AS date_of_nomination_of_competenta_authority, FORMAT(draft_letter_to_con_for_approval_ca ,'%d-%m-%Y') AS draft_letter_to_con_for_approval_ca, FORMAT(date_of_approval_of_construction_ca ,'%d-%m-%Y') AS date_of_approval_of_construction_ca, " + 
					"FORMAT(date_of_uploading_of_gazette_notification_ca ,'%d-%m-%Y') AS date_of_uploading_of_gazette_notification_ca, FORMAT(publication_in_gazette_ca ,'%d-%m-%Y') AS publication_in_gazette_ca, FORMAT(date_of_submission_of_draft_notification_to_CALA ,'%d-%m-%Y') AS date_of_submission_of_draft_notification_to_CALA,FORMAT(approval_of_CALA_20a ,'%d-%m-%Y') AS approval_of_CALA_20a,FORMAT(draft_letter_to_con_for_approval_20a ,'%d-%m-%Y') AS draft_letter_to_con_for_approval_20a," + 
					"FORMAT(date_of_approval_of_construction_20a ,'%d-%m-%Y') AS date_of_approval_of_construction_20a,FORMAT(date_of_uploading_of_gazette_notification_20a ,'%d-%m-%Y') AS date_of_uploading_of_gazette_notification_20a,FORMAT(publication_in_gazette_20a ,'%d-%m-%Y') AS publication_in_gazette_20a,FORMAT(publication_in_2_local_news_papers_20a ,'%d-%m-%Y') AS publication_in_2_local_news_papers_20a,FORMAT(pasting_of_notification_in_villages_20a ,'%d-%m-%Y') AS pasting_of_notification_in_villages_20a," + 
					"FORMAT(receipt_of_grievances ,'%d-%m-%Y') AS  receipt_of_grievances, FORMAT(disposal_of_grievances ,'%d-%m-%Y') AS disposal_of_grievances, FORMAT(date_of_submission_of_draft_notification_to_CALA_20e ,'%d-%m-%Y') AS date_of_submission_of_draft_notification_to_CALA_20e, FORMAT(approval_of_CALA_20e ,'%d-%m-%Y') AS  approval_of_CALA_20e,FORMAT(draft_letter_to_con_for_approval_20e ,'%d-%m-%Y') AS  draft_letter_to_con_for_approval_20e,"
					+ "FORMAT(date_of_approval_of_construction_20e ,'%d-%m-%Y') AS  date_of_approval_of_construction_20e,FORMAT(date_of_uploading_of_gazette_notification_20e ,'%d-%m-%Y') AS date_of_uploading_of_gazette_notification_20e,FORMAT(publication_in_gazette_20e ,'%d-%m-%Y') AS  publication_in_gazette_20e,FORMAT(publication_of_notice_in_2_local_news_papers_20e ,'%d-%m-%Y') AS publication_of_notice_in_2_local_news_papers_20e,FORMAT(date_of_submission_of_draft_notification_to_CALA_20f ,'%d-%m-%Y') AS date_of_submission_of_draft_notification_to_CALA_20f," + 
					"FORMAT(approval_of_CALA_20f ,'%d-%m-%Y') AS approval_of_CALA_20f,FORMAT(draft_letter_to_con_for_approval_20f ,'%d-%m-%Y') AS draft_letter_to_con_for_approval_20f,FORMAT(date_of_approval_of_construction_20f ,'%d-%m-%Y') AS date_of_approval_of_construction_20f,FORMAT(date_of_uploading_of_gazette_notification_20f ,'%d-%m-%Y') AS date_of_uploading_of_gazette_notification_20f,FORMAT(publication_in_gazette_20f ,'%d-%m-%Y') AS publication_in_gazette_20f," + 
					"FORMAT(publication_of_notice_in_2_local_news_papers_20f ,'%d-%m-%Y') AS publication_of_notice_in_2_local_news_papers_20f " + 
	...
	public List<LandAcquisition> getPrivateValList(String la_id) throws Exception {
		List<LandAcquisition> objList = null;
		try {
			String qry = "select la_id_fk,lpv.payment_amount_units,FORMAT(lpv.forest_tree_survey ,'%d-%m-%Y') AS forest_tree_survey,FORMAT(lpv.forest_tree_valuation ,'%d-%m-%Y') AS forest_tree_valuation, lpv.forest_tree_valuation_status_fk,FORMAT(lpv.horticulture_tree_survey ,'%d-%m-%Y') AS horticulture_tree_survey,FORMAT(lpv.horticulture_tree_valuation ,'%d-%m-%Y') AS horticulture_tree_valuation," + 
					"FORMAT(lpv.structure_survey ,'%d-%m-%Y') AS structure_survey,FORMAT(lpv.structure_valuation ,'%d-%m-%Y') AS structure_valuation,FORMAT(lpv.borewell_survey ,'%d-%m-%Y') AS borewell_survey,FORMAT(lpv.borewell_valuation ,'%d-%m-%Y') AS borewell_valuation, lpv.horticulture_tree_valuation_status_fk, lpv.structure_valuation_status_fk," + 
					"lpv.borewell_valuation_status_fk, lpv.rfp_to_adtp_status_fk, FORMAT(lpv.date_of_rfp_to_adtp ,'%d-%m-%Y') AS date_of_rfp_to_adtp,FORMAT(lpv.date_of_rate_fixation_of_land ,'%d-%m-%Y') AS date_of_rate_fixation_of_land, FORMAT(lpv.sdo_demand_for_payment ,'%d-%m-%Y') AS sdo_demand_for_payment,FORMAT(lpv.date_of_approval_for_payment ,'%d-%m-%Y') AS date_of_approval_for_payment," + 
					"cast(lpv.payment_amount as CHAR) as payment_amount, FORMAT(lpv.payment_date ,'%d-%m-%Y') AS private_payment_date  " + 
	...
	public List<LandAcquisition> getGovList(String la_id) throws Exception {
		List<LandAcquisition> objList = null;
		try {
			String qry = "select la_id_fk,lg.id, lg.la_id_fk,FORMAT(lg.proposal_submission,'%d-%m-%Y') AS proposal_submission, lg.proposal_submission_status_fk, FORMAT(lg.valuation_date,'%d-%m-%Y') AS valuation_date, FORMAT(lg.letter_for_payment,'%d-%m-%Y') AS letter_for_payment," + 
					"lg.amount_demanded,cast(lg.lfp_status_fk as CHAR) as lfp_status_fk,FORMAT(lg.approval_for_payment,'%d-%m-%Y') AS approval_for_payment,FORMAT(lg.payment_date,'%d-%m-%Y') AS payment_date, lg.amount_paid, lg.payment_status_fk, FORMAT(lg.possession_date,'%d-%m-%Y') AS possession_date," + 
					"lg.possession_status_fk,FORMAT(lg.planned_date_of_possession ,'%d-%m-%Y') as planned_date_of_possession " + 
	...
	public List<LandAcquisition> getForestList(String la_id) throws Exception {
		List<LandAcquisition> objList = null;
		try {
			String qry = "select la_id_fk, FORMAT(lf.on_line_submission,'%d-%m-%Y') AS forest_online_submission, FORMAT(lf.submission_date_to_dycfo,'%d-%m-%Y') AS forest_submission_date_to_dycfo, FORMAT(lf.submission_date_to_ccf_thane,'%d-%m-%Y') AS forest_submission_date_to_ccf_thane, " + 
					"FORMAT(lf.submission_date_to_nodal_officer,'%d-%m-%Y') AS forest_submission_date_to_nodal_officer, FORMAT(lf.submission_date_to_revenue_secretary_mantralaya,'%d-%m-%Y') AS forest_submission_date_to_revenue_secretary_mantralaya, FORMAT(lf.submission_date_to_regional_office_nagpur,'%d-%m-%Y') AS forest_submission_date_to_regional_office_nagpur," + 
					" FORMAT(lf.date_of_approval_by_regional_office_nagpur,'%d-%m-%Y') AS forest_date_of_approval_by_regional_office_nagpur, FORMAT(lf.valuation_by_dycfo,'%d-%m-%Y') AS forest_valuation_by_dycfo,cast(lf.demanded_amount as CHAR) as forest_demanded_amount,cast(lf.payment_amount  as CHAR) as forest_payment_amount, FORMAT(lf.approval_for_payment,'%d-%m-%Y') AS forest_approval_for_payment" + 
					", FORMAT(lf.payment_date,'%d-%m-%Y') AS forest_payment_date,FORMAT(lf.possession_date,'%d-%m-%Y') AS forest_possession_date,lf.possession_status_fk as forest_possession_status_fk," + 
					"lf.payment_status_fk as forest_payment_status_fk" + 
