...
<%-- <jsp:include page="../layout/header.jsp"></jsp:include> --%>
                        ...
                        <div class="row no-mar">
                            <div class="col m12 s12">
                                <table id="safety_status_table" class="mdl-data-table">
                                    ...
                                    <tbody>
										<c:forEach var="obj" items="${safetyStatusDetails.dList1}" varStatus="indexs">
											<tr><td>
												<input type="hidden" id="statusId${indexs.count}" value="${obj.status }" />
												${obj.status }</td>
											<c:forEach var="tObj" items="${safetyStatusDetails.tablesList}" varStatus="index">
												 
												<td><c:forEach var="cObj" items="${safetyStatusDetails.countList}" >
												<c:choose> 
											...
											<td class="last-column "><a onclick="updateRow(${indexs.count})" class="btn waves-effect waves-light bg-m t-c modal-trigger " href="#"> <i class="fa fa-pencil" ></i></a>
										 	<c:forEach var="oSbj"  items="${safetyStatusDetails.dList}" varStatus="indexx"> 
    ...
    <div id="addUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/add-safety-status" id="addStatusForm" name="addStatusForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header black-text">Add Safety Status <span class="right modal-action modal-close"><span
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="safety_status_text" name="status" type="text" class="validate">
                            ...
                            <div class="col s12 m6">
                                <div class="center-align m-1">
                                  <!--   <button
                                        ...
                                        <a href="<%=request.getContextPath()%>/safety-status"
	...
	<div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-safety-status" id=updateStatusForm name="updateStatusForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header bg-m">Update Safety Status <span class="right modal-action modal-close"><span
                            class="material-icons">close</span></span></h5>
                <div class="row">
                    <div class="col m2 hide-on-small"></div>
                    <div class="col m8 s12">
    ...
    <script>
        $(document).ready(function () {
          ...
          /*   // adding table data into table start
            ...
            $('#safety_status_table tbody').append(table_text);
            // adding table data into table ends */

            var table = $('#safety_status_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
         ...
         var validator =  $('#addStatusForm').validate({
         	 rules: {
         		 "status": {
   	        	 ...
   	        	 if(element.attr("id") == "safety_status_text" ){
        	...
        	swal({
    	            ...
    	            if (isConfirm) {
    	               // swal("Deleted!", "Record has been deleted", "success");
    	            	$('#getForm').attr('action', '<%=request.getContextPath()%>/delete-safety-status');
    	    	    	$('#getForm').submit();
    	           }else {
