...
public class WebviewP6DataController {
	@InitBinder
    public void initBinder(WebDataBinder binder) {
        binder.registerCustomEditor(String.class, new StringTrimmerEditor(true));
    }
	
	Logger logger = Logger.getLogger(WebviewP6DataController.class);
	...
	public ModelAndView P6Data(@ModelAttribute P6Data obj,HttpSession session){
		ModelAndView model = new ModelAndView(MobilePageConstants2.p6Grid);
		try {
	...
	public ModelAndView uploadP6Baseline(@ModelAttribute P6Data p6data,RedirectAttributes attributes,HttpSession session){
		...
		try {
			...
			model.setViewName("redirect:/mobileappwebview/p6-data");
