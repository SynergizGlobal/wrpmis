...
<body>
  ...
  <script>
  $(".page-loader").show();
  var url="1.http://203.153.40.44:8000/views/TenderBid/BidProcess?:showAppBanner=false&:display_count=n&:showVizHome=n&:origin=viz_share_link";
	 $.ajax({
