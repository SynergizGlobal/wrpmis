...
import com.synergizglobal.wrpmis.Idao.StructureFormDao;
...
public class StructureFormDaoImpl implements StructureFormDao{
	...
	public List<Structure> getWorksListForFilter(Structure obj) throws Exception {
		List<Structure> objsList = null;
		try {
			String qry = "SELECT s.project_id_fk,w.work_short_name,work_name "
					+ "FROM structure s " + 
	...
	public boolean addStructureForm(Structure obj) throws Exception {
		...
		try {
			...
			String qry = "INSERT INTO structure"
					+ "(structure,structure_name,project_id_fk,structure_type_fk,target_date,construction_start_date,actual_completion_date,commissioning_date,"
