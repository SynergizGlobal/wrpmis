                        ...
                        <div class="row no-mar">
                            <div class="col s12 center-align">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Mother Tongue</a>
                            </div>
                        </div>
                        <div class="row no-mar">
                            <div class="col m12 s12">
                                <table id="rr_mother_tongue_table" class="mdl-data-table">
                                    <thead>
                                        <tr>
                                            <th> Mother Tongue</th>
                    ...
                    <div class="col m8 s12 offset-m2">
                       <div class="row no-mar">
                         <div class="input-field col s12 m12">
                                ...
                                <label for="value_new"> Mother Tongue</label>
    ...
    <script>
        $(document).ready(function () {
          ...
          /*   // adding table data into table start
            ...
            $('#rr_mother_tongue_table tbody').append(table_text);
            // adding table data into table ends */

            var table = $('#rr_mother_tongue_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
        ...
        function addVerificationBy(){
          	 if(validator.form()){ 
      			...
      			document.getElementById("addMotherTongueForm").submit();	
             }
         }
        function updateVerificationBy(){
          	 if(validator1.form()){ 
       			$(".page-loader").show();
       			$("#addUpdateModal").modal();
       			document.getElementById("updateMotherTongueForm").submit();	
           }
       }
         ...
         var validator1 = $('#updateMotherTongueForm').validate({
        	 rules: {
        		 	"value_new": {
    			 		  required: true
        			 }
