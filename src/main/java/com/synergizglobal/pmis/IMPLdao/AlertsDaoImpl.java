	...
	public boolean generateAterts() throws Exception {
		...
		try {
			...
			String bgQryAlert1 = "select bg.contract_id_fk as contract_id, '1st Alert' as alert_level,'Bank Guarantee' as alert_type,"
					...
					+ "concat('/get-contract?contract_id=',bg.contract_id_fk) as redirect_url,hod_user_id_fk,dy_hod_user_id_fk,u.reporting_to_id_srfk as reporting_to_user_id,"
			...
			String cpQryAlert1 = "select contract_id,'1st Alert' as alert_level,'Contract Period' as alert_type," 
					...
					+ "concat('/get-contract?contract_id=',contract_id) as redirect_url,hod_user_id_fk,dy_hod_user_id_fk,u.reporting_to_id_srfk as reporting_to_user_id,"
			...
			String cvQryAlert1 = "select c.contract_id,'1st Alert' as alert_level,'Contract Value' as alert_type,"
					...
					+ ") AS alert_value," 
					+ "concat('/get-contract?contract_id=',c.contract_id) as redirect_url,hod_user_id_fk,dy_hod_user_id_fk,u.reporting_to_id_srfk as reporting_to_user_id "  
					+ "from contract c "  
