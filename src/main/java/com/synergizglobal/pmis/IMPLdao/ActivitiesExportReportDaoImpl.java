		...
		try {
			...
			{			
			 qry = "      \r\n" + 
					...
					")    \r\n" + 
					"    \r\n" + 
					"select distinct works as works,case when works in ( 'Final lining','heading','rock cutting','approach cutting','drain','benching', 'earthwork filling','railway earth filling',      \r\n" + 
