...
<%-- <jsp:include page="../layout/header.jsp"></jsp:include> --%>
                            ...
                            <div class="col m12 s12">
                                <table id="dashboard_type_table" class="mdl-data-table">
                                    ...
                                    <c:forEach var="obj" items="${dashBoardTypeDetails.dList1}" varStatus="indexs">
											<tr><td>
												<input type="hidden" id="dashboard_typeId${indexs.count}" value="${obj.dashboard_type }" />
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="dashboard_type_text" name="dashboard_type" type="text" class="validate">
                        ...
                        <div class="row">
                            <div class="col s12 m6">
                                <div class="center-align m-1">
                                    <button style="width: 100%;" onclick="addDashboardType()"
    ...
    <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-dashboard-type" id=updateDashboardTypeForm name="updateDashboardTypeForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header bg-m">Update Dashboard Type <span class="right modal-action modal-close"><span
                            class="material-icons">close</span></span></h5>
                <div class="row">
                    <div class="col m2 hide-on-small"></div>
                    <div class="col m8 s12">
                       <div class="row no-mar">
                         <div class="input-field col s12 m12">
                                <input id="dashboard_type_new" type="text" name="dashboard_type_new" class="validate">
                        ...
                        <div class="row">
                            <div class="col s12 m6">
                                <div class="center-align m-1">
                                    <button style="width: 100%;" onclick="updateDashboardType()"
