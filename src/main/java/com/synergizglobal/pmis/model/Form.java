...
public class Form {
	...
	folder_name,form_access_id,form_id_fk,access_type,access_value,access_value_id,access_value_name,display_in_mobile,user_role_access,user_type_access,user_access;
