                        ...
                        <div class="row no-mar">
                            <div class="col s12 center-align">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Caste</a>
                            </div>
                        </div>
                        <div class="row no-mar">
                    ...
                    <div class="col m8 s12 offset-m2">
                       <div class="row no-mar">
                         <div class="input-field col s12 m12">
                                ...
                                <label for="value_new"> Caste</label>
    ...
    <script>
        ...
        function addVerificationBy(){
          	 if(validator.form()){ 
      			...
      			document.getElementById("addCasteForm").submit();	
             }
         }
        function updateVerificationBy(){
          	 if(validator1.form()){ 
       			$(".page-loader").show();
       			$("#addUpdateModal").modal();
       			document.getElementById("updateCaste").submit();	
           }
       }
         ...
         var validator1 = $('#updateCaste').validate({
        	 rules: {
        		 	"value_new": {
    			 		  required: true
        			 }
