...
public class TrainingStatusDaoImpl  implements TrainingStatusDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='training_status' and s.name='dbo'\r\n" + 
	...
	public boolean updateTrainingStatus(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table training_status NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table training_status CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
