...
<head>
	<meta charset="UTF-8">
	<title>Report for the Period - Reports - PMIS</title>
					...
					<div class="center-align">
						<span class="card-title headbg">
							<div class="center-align p-2 bg-m m-b-2">
								<h6 id="rptName">Report For the Period</h6>
							</div>
						</span>
					</div>
					<!-- form start-->
	...
	<script>
      ...
      let date_pickers = document.querySelectorAll('.datepicker');
        ...
        function clearFilters(){
        	...
        	window.location.href= "<%=request.getContextPath()%>/newline-report-fortheperiod-report";
        }
