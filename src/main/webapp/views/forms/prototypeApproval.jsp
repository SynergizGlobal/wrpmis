...
<head>
	<meta charset="UTF-8">
	<title>Prototype Approval</title>
...
<body>
  ...
  <script>
  $(".page-loader").show();
  var url="http://203.153.40.44:8000/views/RollingStockDesignPrototypeApproval/RollingStockDesignPrototypeApproval?:showAppBanner=false&:display_count=n&:showVizHome=n&:origin=viz_share_link";
	 $.ajax({
