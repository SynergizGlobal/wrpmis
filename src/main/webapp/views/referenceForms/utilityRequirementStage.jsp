...
<head>
    ...
    <title>Utility Requirement Stage</title>
...
<%-- <jsp:include page="../layout/header.jsp"></jsp:include> --%>
                ...
                <div class="card-content">
                    <span class="card-title headbg">
                        <div class="center-align bg-m p-2 m-b-5">
                            <h5> Utility Requirement Stage</h5>
                        </div>
                    </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col m4 s12 center-align">
                                <a class="waves-effect waves-light btn bg-m modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add Utility Requirement Stage</a>
                            </div>
                            <div class="col m4 hide-on-small"></div>
                        </div>
                        <div class="row no-mar">
                            <div class="col m12 s12">
                                <table id="utility_requirement_stage_table" class="mdl-data-table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
										<c:forEach var="obj" items="${utilityRequirementStageList}">
											<tr><td>${obj.requirement_stage }</td>
    ...
    <div id="addUpdateModal" class="modal">
		<form action="<%=request.getContextPath() %>/add-utility-requirement-stage" id="requirementStageForm" name="requirementStageForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h5 class="modal-header">Add Utility Requirement Stage <span class="right modal-action modal-close"><span
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="utility_requirement_stage_text" name="requirement_stage" type="text" class="validate">
                                <label for="utility_requirement_stage_text">Utility Requirement Stage</label>
                        ...
                        <div class="row">
                            <div class="col s12 m6">
                                <div class="center-align m-1">
                                    <button style="width: 100%;" onclick="addRequirementStage();"
                                        class="btn waves-effect waves-light bg-m">Add </button>
                                </div>
                            </div>
                           <div class="col s12 m6">
                                <div class="center-align m-1">
                                    <a href="<%=request.getContextPath()%>/utility-requirement-stage"
...
/* 
            ...
            $('#utility_requirement_stage_table tbody').append(table_text);
            // adding table data into table ends */

            var table = $('#utility_requirement_stage_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
	    ...
	    function addRequirementStage(){
	        	 if(validator.form()){ 
	    			$(".page-loader").show();
	    			$("#addUpdateModal").modal();
	    			document.getElementById("requirementStageForm").submit();	
	        	}
	     }
	     
	     var validator = $('#requirementStageForm').validate({
	    	 rules: {
	    		 "requirement_stage": {
				 		  required: true
				 	  }
	     	 ...
	     	 if(element.attr("id") == "utility_requirement_stage_text" ){
