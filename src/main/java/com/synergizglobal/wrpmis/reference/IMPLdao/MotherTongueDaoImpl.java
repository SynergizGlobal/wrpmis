...
public class MotherTongueDaoImpl implements MotherTongueDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='mother_tongue' and s.name='dbo'\r\n" + 
	...
	public boolean updateMotherTongue(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table mother_tongue NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table mother_tongue CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
