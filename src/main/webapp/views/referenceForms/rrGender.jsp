...
<body>
                        ...
                        <div class="row no-mar">
                            <div class="col s12 center-align">
                                <a class="waves-effect waves-light btn bg-s modal-trigger t-c" href="#addUpdateModal">
                                    <i class="fa fa-plus-circle"></i> &nbsp; Add  Gender</a>
                            </div>
                        </div>
                        <div class="row no-mar">
                            <div class="col m12 s12">
                                <table id="rr_gender_table" class="mdl-data-table">
                                    <thead>
                                        <tr>
                                            <th> Gender</th>
                                    ...
                                    <tbody>
										<c:forEach var="obj" items="${rrSVerificationByDetails.dList1}" varStatus="indexs">
											<tr><td>
												<input type="hidden" id="statusId${indexs.count}" value="${obj.rr_gender }"  class="findLengths" />
												${obj.rr_gender }</td>
											<c:forEach var="tObj" items="${rrSVerificationByDetails.tablesList}" varStatus="index">
												...
												<c:choose> 
													    <c:when test="${tObj.tName eq cObj.tName }"> 
													    		...
													    		<c:choose>  
																    <c:when test="${cObj.rr_gender eq obj.rr_gender }"> 
																      	 ( ${cObj.count } )   
																    </c:when>  
																    <c:otherwise>  
																    </c:otherwise>   
											...
											<td class="last-column "><a onclick="updateRow(${indexs.count})" class="btn waves-effect waves-light bg-m t-c modal-trigger " href="#"> <i class="fa fa-pencil" ></i></a>
										 	<c:forEach var="oSbj"  items="${rrSVerificationByDetails.dList}" varStatus="indexx"> 
												...
												<c:choose>  
												    <c:when test="${oSbj.rr_gender eq obj.rr_gender }"> 
												      	<a onclick="deleteRow('${ oSbj.rr_gender }');" id="${indexx.count}" class="btn waves-effect waves-light bg-s t-c modal-trigger"><i class="fa fa-trash"></i>
    ...
    <div id="addUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/add-rr-gender" id="addGenderForm" name="addGenderForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h6 class="modal-header">Add Gender <span class="right modal-action modal-close"><span
                    ...
                    <div class="col m8 s12">
                        <div class="row">
                            <div class="input-field col s12 m12">
                                <input id="rr_verificationby_text" type="text" name="rr_gender" class="validate" onkeyup="doValidate(this.value)">
                                <label for="rr_verificationby_text"> Gender</label>
                             ...
                             <div class="col s12 m6">
                                <div class="center-align m-1">
                                  <!--   <button
                                        ...
                                        <a href="<%=request.getContextPath()%>/rr-gender"
     ...
     <div id="onlyUpdateModal" class="modal">
		 <form action="<%=request.getContextPath() %>/update-rr-gender" id=updateGenderForm name="updateGenderForm" method="post" class="form-horizontal" role="form">
            <div class="modal-content">
                <h6 class="modal-header bg-m">Update  Gender <span class="right modal-action modal-close"><span
                            class="material-icons">close</span></span></h6>
                <div class="row">
                    <div class="col m8 s12 offset-m2">
                       <div class="row no-mar">
                         <div class="input-field col s12 m12">
                                ...
                                <label for="value_new"> Gender</label>
...
<%-- <jsp:include page="../layout/footer.jsp"></jsp:include> --%>
	<form name="getForm" id="getForm" method="post">
    	<input type="hidden" name="rr_gender" id="rr_gender" />
    </form>
    ...
    <script>
        $(document).ready(function () {
          ...
          /*   // adding table data into table start
            ...
            $('#rr_gender_table tbody').append(table_text);
            // adding table data into table ends */

            var table = $('#rr_gender_table').DataTable({
                columnDefs: [
                    {
                        targets: [0],
        ...
        function addVerificationBy(){
          	 if(validator.form()){ 
      			...
      			document.getElementById("addGenderForm").submit();	
             }
         }
        function updateVerificationBy(){
          	 if(validator1.form()){ 
       			$(".page-loader").show();
       			$("#addUpdateModal").modal();
       			document.getElementById("updateGenderForm").submit();	
           }
       }
         var validator =  $('#addGenderForm').validate({
         	 rules: {
         		 "rr_gender": {
   			 		  required: true
         		 }
         ...
         var validator1 = $('#updateGenderForm').validate({
        	 rules: {
        		 	"value_new": {
    			 		  required: true
        			 }
      ...
      function updateRow(no) {
          var rr_gender = $('#statusId'+no).val();
          $('#value_old').val($.trim(rr_gender))
          $('#onlyUpdateModal').modal('open');
          $('#onlyUpdateModal #value_new').val($.trim(rr_gender)).focus();
      }
        	...
        	swal({
    	            ...
    	            if (isConfirm) {
    	               // swal("Deleted!", "Record has been deleted", "success");
    	                $(".page-loader").show();
    	            	$('#getForm').attr('action', '<%=request.getContextPath()%>/delete-rr-gender');
    	    	    	$('#getForm').submit();
    	           }else {
