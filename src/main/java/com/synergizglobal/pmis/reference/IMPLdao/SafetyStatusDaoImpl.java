...
public class SafetyStatusDaoImpl implements SafetyStatusDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='safety_status' and s.name='dbo'\r\n" + 
	...
	public boolean updateSafetyStatus(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table safety_status NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table safety_status CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
