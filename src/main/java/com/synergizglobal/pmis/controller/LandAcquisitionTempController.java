...
@Controller
public class LandAcquisitionTempController {
	Logger logger = Logger.getLogger(LandAcquisitionTempController.class);
	@Autowired
	LandAcquisitionTempService service;
	 ...
	 */
	@RequestMapping(value="/land-acquisition-0",method=RequestMethod.GET)
	public ModelAndView landAcquisition(HttpSession session) throws IOException {
		ModelAndView model = new ModelAndView(PageConstants2.landAcquisition);
		try {
			List<LandAcquisitionTemp> landAcquisitionList = service.getLandAcquisitionList();
			model.addObject("landAcquisitionList", landAcquisitionList);
			
			List<LandAcquisitionTemp> statusList = service.getLandAcquisitionSatausList();
	 ...
	 * @throws IOException will raise an exception when abnormal termination occur.
	 */
	@RequestMapping(value="/get-land-acquisition-0",method=RequestMethod.POST)
	public ModelAndView getLandAcquisition(@RequestParam String landAcquisitionId, HttpSession session) throws IOException {
		ModelAndView model = new ModelAndView(PageConstants2.updateLandAcquisition);
		try {
			model.addObject("homeHeader", "yes");
			List<LandAcquisitionTemp> statusList = service.getLandAcquisitionSatausList();
			model.addObject("statusList", statusList);
			
			LandAcquisitionTemp obj = service.getLandAcquisition(landAcquisitionId);
	...
	@ResponseBody
	public LandAcquisitionTemp getLandAcquisition(@RequestParam String landAcquisitionId){
	 ...
	 * @throws IOException will raise an exception when abnormal termination occur.
	 */
	@RequestMapping(value="/update-land-acquisition-0",method=RequestMethod.POST)
	public ModelAndView updateLandAcquisitionTemp(@ModelAttribute LandAcquisitionTemp obj, HttpSession session,RedirectAttributes attributes) throws IOException {
		ModelAndView model = new ModelAndView("redirect:/land-acquisition-0");
		try {
			...
			e.printStackTrace();
			attributes.addFlashAttribute("error", "Something went wrong. Please try again.");
			logger.info("updateLandAcquisitionTemp : " + e.getMessage());
		}
		return model;
	}
	...
	public ModelAndView landAcquisition1(HttpSession session) throws IOException {
		ModelAndView model = new ModelAndView(PageConstants2.landAcquisition1);
		try {
			List<LandAcquisitionTemp> landAcquisitionList = service.getLandAcquisitionList();
			model.addObject("landAcquisitionList", landAcquisitionList);
	...
	public ModelAndView getLandAcquisition1(@RequestParam String landAcquisitionId, HttpSession session) throws IOException {
		ModelAndView model = new ModelAndView(PageConstants2.updateLandAcquisition1);
		try {
			model.addObject("homeHeader", "yes");
			List<LandAcquisitionTemp> statusList = service.getLandAcquisitionSatausList();
			model.addObject("statusList", statusList);
	...
	public ModelAndView updateLandAcquisition1(@ModelAttribute LandAcquisitionTemp obj, HttpSession session,RedirectAttributes attributes) throws IOException {
	...
	public ModelAndView updateLandAcquisitionStatus(@ModelAttribute LandAcquisitionTemp obj, HttpSession session,RedirectAttributes attributes) throws IOException {
		ModelAndView model = new ModelAndView("redirect:/land-acquisition-1");
		try {
...
/**************************************************************************************************************/
	...
	public ModelAndView landAcquisition2(HttpSession session) throws IOException {
		ModelAndView model = new ModelAndView(PageConstants2.landAcquisition2);
		try {
			List<LandAcquisitionTemp> landAcquisitionList = service.getLandAcquisitionList();
			model.addObject("landAcquisitionList", landAcquisitionList);
	...
	public ModelAndView getLandAcquisition2(@RequestParam String landAcquisitionId, HttpSession session) throws IOException {
		ModelAndView model = new ModelAndView(PageConstants2.updateLandAcquisition2);
		try {
			model.addObject("homeHeader", "yes");
			List<LandAcquisitionTemp> statusList = service.getLandAcquisitionSatausList();
			model.addObject("statusList", statusList);
	...
	public ModelAndView updateLandAcquisition2(@ModelAttribute LandAcquisitionTemp obj, HttpSession session,RedirectAttributes attributes) throws IOException {
	...
	public ModelAndView updateLandAcquisitionStatus2(@ModelAttribute LandAcquisitionTemp obj, HttpSession session,RedirectAttributes attributes) throws IOException {
		ModelAndView model = new ModelAndView("redirect:/land-acquisition-2");
		try {
			boolean flag = service.updateLandAcquisitionStatus(obj);
			if(flag) {
...
/**************************************************************************************************************/
	...
	public ModelAndView landAcquisition3(HttpSession session) throws IOException {
		ModelAndView model = new ModelAndView(PageConstants2.landAcquisition3);
		try {
			List<LandAcquisitionTemp> landAcquisitionList = service.getLandAcquisitionList();
			model.addObject("landAcquisitionList", landAcquisitionList);
	...
	public ModelAndView getLandAcquisition3(@RequestParam String landAcquisitionId, HttpSession session) throws IOException {
		ModelAndView model = new ModelAndView(PageConstants2.updateLandAcquisition3);
		try {
			model.addObject("homeHeader", "yes");
			List<LandAcquisitionTemp> statusList = service.getLandAcquisitionSatausList();
			model.addObject("statusList", statusList);
	...
	public ModelAndView updateLandAcquisition3(@ModelAttribute LandAcquisitionTemp obj, HttpSession session,RedirectAttributes attributes) throws IOException {
	...
	public ModelAndView updateLandAcquisitionStatus3(@ModelAttribute LandAcquisitionTemp obj, HttpSession session,RedirectAttributes attributes) throws IOException {
		ModelAndView model = new ModelAndView("redirect:/land-acquisition-3");
		try {
			boolean flag = service.updateLandAcquisitionStatus(obj);
			if(flag) {
...
/**************************************************************************************************************/
	...
	public ModelAndView landAcquisition4(HttpSession session) throws IOException {
		ModelAndView model = new ModelAndView(PageConstants2.landAcquisition4);
		try {
			List<LandAcquisitionTemp> landAcquisitionList = service.getLandAcquisitionList();
			model.addObject("landAcquisitionList", landAcquisitionList);
	...
	public ModelAndView getLandAcquisition4(@RequestParam String landAcquisitionId, HttpSession session) throws IOException {
		ModelAndView model = new ModelAndView(PageConstants2.updateLandAcquisition4);
		try {
			model.addObject("homeHeader", "yes");
			List<LandAcquisitionTemp> statusList = service.getLandAcquisitionSatausList();
			model.addObject("statusList", statusList);
	...
	public ModelAndView updateLandAcquisition4(@ModelAttribute LandAcquisitionTemp obj, HttpSession session,RedirectAttributes attributes) throws IOException {
	...
	public ModelAndView updateLandAcquisitionStatus4(@ModelAttribute LandAcquisitionTemp obj, HttpSession session,RedirectAttributes attributes) throws IOException {
		ModelAndView model = new ModelAndView("redirect:/land-acquisition-4");
		try {
			boolean flag = service.updateLandAcquisitionStatus(obj);
			if(flag) {
	...
	public ModelAndView landAcquisitionAddForm(HttpSession session) throws IOException {
		ModelAndView model = new ModelAndView(PageConstants2.addEditLandAcquisition);
		try {
