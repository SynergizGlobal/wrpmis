...
public class ResourceTypeDaoImpl implements ResourceTypeDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='resource_type' and s.name='dbo'\r\n" + 
	...
	public boolean updateResourceType(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table resource_type NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table resource_type CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
