...
public class WebviewValidateDataController {
	@InitBinder
    public void initBinder(WebDataBinder binder) {
        binder.registerCustomEditor(String.class, new StringTrimmerEditor(true));
    } 
	public static Logger logger = Logger.getLogger(WebviewValidateDataController.class);
	...
	@RequestMapping(value="/validate-data-page",method={RequestMethod.GET,RequestMethod.POST})
	public ModelAndView progressApprovalPage(@ModelAttribute Activity obj){		
		 ModelAndView model = new ModelAndView(MobilePageConstants2.validateDataGrid);	    
	     try {
